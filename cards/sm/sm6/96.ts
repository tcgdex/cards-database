...
const card: Card = {
	...
	attacks: [{
		...
		text: {
			...
			fr: "Vous ne pouvez utiliser cette attaque que si vous avez des Plante, Eau et Éléctrique sur votre Banc. Cherchez jusqu’à 3 cartes Énergie de base dans votre deck et attachez-les à vos Pokémon, de la manière que vous voulez. Mélangez ensuite votre deck.",
		},
		damage: 30
	}],
