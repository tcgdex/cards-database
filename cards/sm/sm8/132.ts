...
const card: Card = {
	...
	image: {
		low: {
			en: "https://assets.tcgdex.net/en/sm/sm8/132/low.png",
			fr: "https://assets.tcgdex.net/fr/sm/sm8/132/low.png",
		},
		high: {
			en: "https://assets.tcgdex.net/en/sm/sm8/132/high.png",
			fr: "https://assets.tcgdex.net/fr/sm/sm8/132/high.png",
		},
	},
	...
	abilities: [{
		...
		text: {
			en: "When you play this Pokémon from your hand to evolve 1 of your Pok��mon during your turn, you may search your deck for up to 2 Item cards, reveal them, and put them into your hand. Then, shuffle your deck.",
