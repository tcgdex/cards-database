...
const card: Card = {
	...
	image: {
		low: {
			en: "https://assets.tcgdex.net/en/sm/sm8/98/low.png",
			fr: "https://assets.tcgdex.net/fr/sm/sm8/98/low.png",
		},
		high: {
			en: "https://assets.tcgdex.net/en/sm/sm8/98/high.png",
			fr: "https://assets.tcgdex.net/fr/sm/sm8/98/high.png",
		},
	},
	...
	abilities: [{
		...
		text: {
			...
			fr: "Si ce Pokémon est votre Pokémon Actif et qu’il subit les dégâts d’une attaque d’un Pokémon-GX ou Pokémon-EX de votre adversaire (même si ce Pokémon est mis K.O.), placez des marqueurs de dégâts sur le Pokémon Attaquant équivalents aux dégâts infligés à ce Pokémon.",
		}
	}],
