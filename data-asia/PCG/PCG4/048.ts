      ...
      attacks: [
        {
          ...
          effect: {
            en: "Flip 3 coins. If 1 of them is heads, the Defending Pokemon is now Asleep. If 2 of them are heads, the Defending Pokemon is now Confused. If all of them are heads, the Defending Pokemon is now Paralyzed.",
            ja: "3コインをフリップします。それらの1つが頭の場合、防御ポケモンは今眠っています。それらの2つがヘッドである場合、防御するポケモンは今混乱しています。それらのすべてがヘッドである場合、防御ポケモンは現在麻痺しています。",
            fr: "Flip 3 pièces. Si l'un d'entre eux fait des têtes, le Pokémon en défense est maintenant endormi. Si 2 d'entre eux sont des têtes, le Pokémon en défense est maintenant confus. Si tous sont des têtes, le Pokémon en défense est maintenant paralysé.",
            de: "3 Münzen umdrehen. Wenn 1 von ihnen Köpfe sind, schläft das verteidigende Pokémon jetzt. Wenn 2 von ihnen Köpfe sind, ist das verteidigende Pokémon jetzt verwirrt. Wenn alle von ihnen Köpfe sind, ist das verteidigende Pokémon jetzt gelähmt.",
            es: "Flip 3 monedas. Si 1 de ellos son cabezas, el Pokémon defensor ahora está dormido. Si 2 de ellas son cabezas, el Pokémon defensor ahora está confundido. Si todos son cabezas, el Pokémon defensor ahora está paralizado.",
            it: "Flip 3 monete. Se 1 di loro è testa, il Pokemon in difesa è ormai addormentato. Se 2 di loro sono teste, il Pokemon in carica è ora confuso. Se tutti sono teste, il Pokemon in carica è ora paralizzato.",
            pt: "Flip 3 moedas. Se 1 deles é cabeças, o Pokémon atual está agora dormindo. Se 2 deles são cabeças, o Pokemon atual agora está confuso. Se todos eles são cabeças, o Pokémon atual está agora paralisado.",
          },
          damage: 10,
        },
      ],
