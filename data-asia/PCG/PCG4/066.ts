      ...
      attacks: [
        {
          ...
          effect: {
            en: "Flip a coin. If heads, put 2 damage counters on 1 of your opponent's Pokemon. If tails, put 2 damage counters on 1 of your Pokemon.",
            ja: "コインをひっくり返します。頭の場合は、相手のポケモンの1つに2つのダメージカウンターを入れます。尾の場合、ポケモンの1つに2つのダメージカウンターを入れます。",
            fr: "Retourner une pièce. Si les têtes, mettez 2 compteurs de dégâts sur 1 du pokemon de votre adversaire. Si Tails, mettez 2 compteurs de dégâts sur 1 de votre Pokémon.",
            de: "Eine Münze drehen. Wenn Sie Köpfe haben, legen Sie 2 Schadenszähler auf einen der Pokémon Ihres Gegners. Wenn Sie Schwänze haben, legen Sie 2 Schadenszähler auf 1 Ihres Pokémon.",
            es: "Voltea una moneda. Si se dirige, coloque 2 contadores de daño en 1 de los Pokémon de tu oponente. Si las colas, coloque 2 contadores de daño en 1 de su Pokémon.",
            it: "Capovolgi una moneta. Se le teste, metti 2 contatori di danno su 1 del Pokemon del tuo avversario. Se coda, metti 2 contatori di danno su 1 del tuo Pokemon.",
            pt: "Vire uma moeda. Se as cabeças, coloque 2 contadores de danos em 1 dos Pokémon do seu oponente. Se a cauda, coloque 2 contadores de danos em 1 do seu Pokémon.",
          },
        },
      ],
