      ...
      attacks: [
        {
          ...
          effect: {
            ...
            fr: "Recherchez votre deck jusqu'à 2 cartes supporters, montrez-les à votre adversaire et mettez-les dans votre main. Mélanger votre deck par la suite.",
            de: "Suchen Sie Ihr Deck nach bis zu 2 Unterstützerkarten, zeigen Sie sie Ihrem Gegner an und legen Sie sie in Ihre Hand. Mischen Sie anschließend Ihr Deck.",
            es: "Busque en su mazo hasta 2 cartas de partidarios, muéstrelos a su oponente y póngalos en su mano. Baraja tu mazo después.",
            it: "Cerca nel tuo mazzo per un massimo di 2 carte sostenitrici, mostrale al tuo avversario e mettile in mano. Shuffle il tuo mazzo in seguito.",
            pt: "Pesquise seu baralho por até 2 cartas de apoiadores, mostre -as ao seu oponente e coloque -as em sua mão. Afaste seu baralho depois.",
          },
        },
      ],
