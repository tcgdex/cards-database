      ...
      attacks: [
        {
          ...
          effect: {
            ...
            fr: "Retourner une pièce. Si les têtes, recherchez votre tas de défausse pour une carte, montrez-la à votre adversaire et mettez-la sur votre jeu.",
            de: "Eine Münze drehen. Wenn Sie Köpfe sind, suchen Sie Ihren Ablagerungsstapel nach einer Karte, zeigen Sie sie Ihrem Gegner an und legen Sie ihn auf Ihr Deck.",
            es: "Voltea una moneda. Si se dirige, busque en su pila de descarte en busca de una carta, muéstrela a su oponente y póngalo encima de su mazo.",
            it: "Capovolgi una moneta. Se le teste, cerca il tuo mucchio di scarti per una carta, mostralo al tuo avversario e mettilo sopra il mazzo.",
            pt: "Vire uma moeda. Se as cabeças, procure um cartão de descarte, mostre -o ao seu oponente e coloque -o em cima do seu baralho.",
          },
          damage: 20,
        },
      ],
