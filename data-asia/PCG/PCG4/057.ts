      ...
      attacks: [
        {
          ...
          effect: {
            ...
            ja: "未使用とそれに取り付けられたすべてのエネルギーカードをあなたの手に返してください。",
            fr: "Retournez un-bas et toutes les cartes d'énergie qui y sont attachées à votre main.",
            de: "Kehren Sie unown und alle an Ihrer Hand befestigten Energiekarten zurück.",
            es: "Regrese sin OSD y todas las tarjetas de energía adjuntas a su mano.",
            it: "Restituisci Unown e tutte le carte energetiche attaccate alla tua mano.",
            pt: "Retorne o UNOWN e todos os cartões de energia anexados à sua mão.",
          },
          damage: 20,
        },
      ],
