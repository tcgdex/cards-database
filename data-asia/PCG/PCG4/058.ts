      ...
      attacks: [
        {
          ...
          effect: {
            en: "Put 1 damage counter on each of your opponent's Pokemon that already has damage counters on it.",
            ja: "既にダメージカウンターを持っている相手のポケモンのそれぞれに1つのダメージカウンターを置きます。",
            fr: "Mettez 1 compteur de dégâts sur chacun des Pokémon de votre adversaire qui a déjà des compteurs de dégâts dessus.",
            de: "Legen Sie 1 Schadenschalter auf das Pokémon Ihres Gegners, das bereits Schadenszähler hat.",
            es: "Pon 1 contador de daño en el Pokémon de cada uno de tu oponente que ya tiene contadores de daño.",
            it: "Metti 1 contatore di danni su ciascuno dei Pokemon del tuo avversario che ha già contatori di danni su di esso.",
            pt: "Coloque 1 contador de danos em cada um dos Pokémon do seu oponente que já possui contadores de danos.",
          },
        },
      ],
