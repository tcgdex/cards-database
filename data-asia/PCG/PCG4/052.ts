      ...
      attacks: [
        {
          ...
          effect: {
            en: "Flip a coin. If heads, switch all damage counters on Unown with those on the Defending Pokemon. (If an effect of this attack is prevented, this attack does nothing.)",
            ja: "コインをひっくり返します。ヘッドの場合、防御ポケモンの人とはすべて、すべてのダメージカウンターを切り替えてください。 （この攻撃の影響が防止された場合、この攻撃は何もしません。）",
            fr: "Retourner une pièce. Si les têtes, changez tous les compteurs de dégâts sur non-bas avec ceux du Pokémon en défense. (Si un effet de cette attaque est empêché, cette attaque ne fait rien.)",
            de: "Eine Münze drehen. Wenn Sie Köpfe haben, wechseln Sie alle Schadenszähler auf Unown mit denen auf dem verteidigenden Pokémon. (Wenn ein Effekt dieses Angriffs verhindert wird, tut dieser Angriff nichts.)",
            es: "Voltea una moneda. Si se dirige, cambie todos los contadores de daño en Under con los que están en el Pokémon defensor. (Si se evita un efecto de este ataque, este ataque no hace nada).",
            it: "Capovolgi una moneta. Se le teste, passa tutti i contatori di danno su UNOW con quelli sul Pokemon in difesa. (Se viene impedito un effetto di questo attacco, questo attacco non fa nulla.)",
            pt: "Vire uma moeda. Se as cabeças, alterne todos os contadores de danos no UNOWN com os que estão no Pokémon atual. (Se um efeito desse ataque for impedido, esse ataque não fará nada.)",
          },
        },
      ],
