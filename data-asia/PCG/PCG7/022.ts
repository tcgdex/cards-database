      ...
      attacks: [
        {
          ...
          effect: {
            en: "Switch Deoxys with 1 of your Benched Pokemon.",
            ja: "ベンチ付きポケモンの1つでデオキシを切り替えます。",
            fr: "Communiquez des désoxys avec 1 de votre pokemon banc.",
            de: "Wechseln Sie die Desoxys mit 1 Ihrer Bank -Pokémon.",
            es: "Cambie los desoxys con 1 de su Pokémon de banca.",
            it: "Cambia Deoxys con 1 del tuo Pokemon in panchina.",
            pt: "Mudar Deoxys com 1 do seu Pokémon em banco.",
          },
          damage: 20,
        },
      ],
