      ...
      attacks: [
        {
          ...
          effect: {
            ...
            fr: "Jeter toutes les cartes d'énergie attachées à idem.",
            de: "Verwerfen Sie alle an Ditto angeschlossenen Energiekarten.",
            es: "Deseche todas las tarjetas de energía unidas a ídem.",
            it: "Scartare tutte le carte di energia collegate a Idem.",
            pt: "Descarte todos os cartões de energia anexados ao idem.",
          },
          damage: 40,
        },
      ],
