      ...
      attacks: [
        {
          ...
          effect: {
            ...
            fr: "Vous pouvez retourner une pièce. If heads, discard all Lightning Energy cards attached to Raikou. Cette attaque fait 40 dégâts plus 20 dégâts supplémentaires pour chaque carte d'énergie jetée de cette manière.",
