      ...
      abilities: [
        {
          ...
          effect: {
            en: "Once during your turn <em>(before your attack)</em>, you may discard a card from your hand. If you do, draw a card.  This power can't be used if this Pokémon is affected by a Special Condition.",
            ja: "順番<em>（攻撃の前）</em>中に、手からカードを捨てることができます。もしそうなら、カードを描きます。  このポケモンが特別な状態の影響を受けている場合、このパワーは使用できません。",
            fr: "Une fois pendant votre tour <em> (avant votre attaque) </em>, vous pouvez jeter une carte de votre main. Si vous le faites, tracez une carte.  Ce pouvoir ne peut pas être utilisé si ce Pokémon est affecté par une condition spéciale.",
            ...
            it: "Una volta durante il tuo turno <em> (prima del tuo attacco) </em>, puoi scartare una carta dalla tua mano. Se lo fai, disegna una carta.  Questa potenza non può essere utilizzata se questo Pokémon è influenzato da una condizione speciale.",
            pt: "Uma vez durante o seu turno <em> (antes do seu ataque) </em>, você pode descartar um cartão da sua mão. Se o fizer, desenhe um cartão.  Esse poder não pode ser usado se esse Pokémon for afetado por uma condição especial.",
          },
      }],
