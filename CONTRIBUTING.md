...
We as tcgdex do not allow AI-assisted data. This is to ensure that all contributions are human-made and maintain the quality and integrity of the project.
While we understand that AI can be a useful tool for generating code, it is important to remember that AI-generated code may not always be accurate or reliable and must be thoroughly checked and understood.
Therefore, we also ask that all data contributions to the project be made by humans only. any PR that seems to be generated by AI will be rejected.

If you are using AI please make sure that you are using it responsibly, you may come ask us in the discord if you want to check if your usage will be rejected or not.
