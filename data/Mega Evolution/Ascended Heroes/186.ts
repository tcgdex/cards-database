...
const card: Card = {
	...
	name: {
		...
		'es-mx': "Ganancia de Contraataque",
		de: "Kontergewinn",
		it: "Contrappeso",
	...
	effect: {
		...
		'es-mx': "Si te quedan más cartas de Premio que a tu rival, los ataques usados por el Pokémon al que esté unida esta carta cuestan {C} menos.",
