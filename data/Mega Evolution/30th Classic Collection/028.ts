...
const card: Card = {
	...
	abilities: [{
		...
		effect: {
			...
			'es-mx': "Una vez durante tu turno, puedes mirar las primeras 3 cartas de tu mazo y unir cualquier cantidad de cartas de Energía Metal que encuentres entre ellas a este Pokémon. Pon el resto de las cartas en tu mano. Si usas esta Habilidad, tu turno termina."
		}
	}],
