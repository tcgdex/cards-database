...
const card: Card = {
	...
	effect: {
		...
		de: "Mische deine Handkarten in dein Deck. Ziehe anschließend 6 Karten. Wenn du genau 6 verbleibende Preiskarten hast, ziehe stattdessen 8 Karten. Du kannst während deines Zuges nur 1 Unterstützerkarte spielen.",
