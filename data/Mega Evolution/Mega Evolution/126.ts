...
const card: Card = {
	...
	effect: {
		...
		de: "Wechsle das Aktive Pokémon deines Gegners auf seine Bank aus. (Dein Gegner wählt das neue Aktive Pokémon.) Du kannst während deines Zuges beliebig viele Itemkarten spielen.",
