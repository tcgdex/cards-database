...
const card: Card = {
	...
	effect: {
		...
		de: "Dein Gegner zeigt dir seine Handkarten und du wählst 1 Energiekarte, die du dort findest, und legst sie unter sein Deck. Du kannst während deines Zuges beliebig viele Itemkarten spielen.",
