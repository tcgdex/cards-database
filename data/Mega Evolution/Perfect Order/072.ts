...
const card: Card = {
	...
	effect: {
		...
		'es-mx': "Busca en tu mazo 1 carta de Energía Básica, muéstrala y ponla en tu mano. Después, baraja tu mazo.",
		de: "Durchsuche dein Deck nach 1 Basis-Energiekarte, zeige sie deinem Gegner und nimm sie auf deine Hand. Mische anschließend dein Deck. Du kannst während deines Zuges beliebig viele Itemkarten spielen.",
