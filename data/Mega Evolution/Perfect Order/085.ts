...
const card: Card = {
	...
	effect: {
		...
		de: "Nimm eine beliebige Kombination aus bis zu 4 {F}-Pokémon und Basis-{F}-Energiekarten aus deinem Ablagestapel auf deine Hand. Du kannst während deines Zuges nur 1 Unterstützerkarte spielen.",
