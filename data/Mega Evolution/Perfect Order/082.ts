...
const card: Card = {
	...
	effect: {
		...
		de: "Wirf 1 Münze. Wechsle bei Kopf 1 Pokémon von der Bank deines Gegners in die Aktive Position ein. Du kannst während deines Zuges beliebig viele Itemkarten spielen.",
