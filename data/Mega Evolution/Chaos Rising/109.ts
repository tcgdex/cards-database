...
const card: Card = {
	...
	effect: {
		...
		de: "Heile 80 Schadenspunkte bei deinem Aktiven Pokémon, an das 3 oder mehr Energien angelegt sind. Du kannst während deines Zuges beliebig viele Itemkarten spielen.",
