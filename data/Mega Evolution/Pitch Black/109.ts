...
const card: Card = {
	...
	effect: {
		...
		de: "Lege bis zu 2 Pokémon, die kein Regelfeld haben, aus deiner Hand auf deinen Ablagestapel und ziehe 3 Karten für jede auf diese Weise abgelegte Karte. (Pokémon-ex, Pokémon-V usw. haben Regelfelder.) Du kannst während deines Zuges nur 1 Unterstützerkarte spielen.",
