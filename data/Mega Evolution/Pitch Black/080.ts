...
const card: Card = {
	...
	effect: {
		...
		de: "Durchsuche dein Deck nach bis zu 4 Basis-{W}-Energiekarten und lege sie an 1 deiner Pokémon an. Mische anschließend dein Deck. Dein Zug endet. Du kannst während deines Zuges nur 1 Unterstützerkarte spielen.",
