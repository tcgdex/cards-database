	...
	attacks: [
		{
			...
			effect: {
				en: "Choose an attack on 1 of your opponent's Pokémon in play. Mimicry copies that attack. This attack does nothing if Mew ☆ doesn't have the Energy necessary to use that attack. (You must still do anything else required for that attack.) Mew ☆ performs that attack.",
		...
		},
		{
			...
			effect: {
				...
				fr: "Choisissez 1 carte Énergie de base attachée à Mew Star. Cette attaque inflige 20 dégâts à chacun des Pokémon de votre adversaire possédant le même type que la carte Énergie de base choisie. (Vous ne pouvez pas appliquer la Faiblesse et la Résistance aux Pokémon de Banc.)",
				de: "Wähle 1 Basis-Energiekarte, die an Mew Star angelegt ist. Dieser Angriff fügt jedem Pokémon deines Gegners, das denselben Typ hat wie die gewählte Basis-Energiekarte, 20 Schadenspunkte zu. (Wende Schwäche und Resistenz bei Pokémon auf der Bank nicht an.)"
			},
