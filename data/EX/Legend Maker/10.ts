	...
	abilities: [
		{
			...
			effect: {
				...
				de: "Einmal während deines Zuges (vor deinem Angriff) kannst du ein Verteidigendes Pokémon auswählen. Mew ist nun bis zum Ende deines Zuges ein Pokémon desselben Typs (oder Typen, wenn das Pokémon mehr als einen Typ hat). Diese Poké-Power kann nicht benutzt werden, wenn Mew von einem Speziellen Zustand betroffen ist."
			},
		},
	],
	...
	attacks: [
		{
			...
			effect: {
				...
				de: "Wenn an Mew und dem Verteidigenden Pokémon unterschiedlich viel Energie angelegt ist, beträgt der Grundschaden dieses Angriffs 20 Schadenspunkte anstelle von 50 Schadenspunkten."
			},
			damage: 50,
