...
const card: Card = {
	...
	effect: {
		...
		de: "Verkrümmungs-Energie liefert {C}-Energie. Wenn du die Verkrümmungs-Energie von der Hand an dein Aktives Pokémon anlegst, tausche dieses Pokémon mit 1 Pokémon auf deiner Bank aus.",
