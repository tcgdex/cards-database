	...
	attacks: [
		...
		},
		{
			...
			effect: {
				...
				fr: "Inflige 30 dégâts plus 20 dégâts supplémentaires pour chaque Énergie {W} attachée à Amonistar qui n'a pas été utilisée pour payer le coût en Énergie de cette attaque. Vous ne pouvez pas ajouter plus de 40 dégâts de cette façon.",
