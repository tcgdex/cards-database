	...
	abilities: [
		{
			...
			effect: {
				...
				fr: "Une seule fois lors de votre tour (avant votre attaque), vous pouvez attacher une carte Énergie {R} de votre pile de défausse à un de vos Pokémon de Banc. Ce pouvoir ne peut être utilisé si Brasegali est affecté par un État Spécial.",
	...
	attacks: [
		{
			...
			effect: {
				...
				fr: "Défaussez une carte Énergie {R} attachée à Brasegali. Cette attaque inflige 10 dégâts à chacun des Pokémon de Banc de votre adversaire. (Vous ne pouvez pas appliquer la Faiblesse et la Résistance aux Pokémon de Banc.)",
