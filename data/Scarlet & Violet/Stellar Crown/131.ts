...
const card: Card = {
	...
	effect: {
		...
		de: "Jeder Spieler, der mindestens 1 Terakristall-Pokémon im Spiel hat, kann bis zu 8 Pokémon auf seiner Bank haben. Wenn ein Spieler keine Terakristall-Pokémon mehr im Spiel hat, legt jener Spieler so lange Pokémon von seiner Bank auf seinen Ablagestapel, bis er 5 Pokémon auf seiner Bank hat. Wenn diese Karte das Spiel verlässt, legen beide Spieler so lange Pokémon von ihrer Bank auf ihren Ablagestapel, bis sie 5 Pokémon auf ihrer Bank haben, und der Spieler, der diese Karte gespielt hat, legt als Erster ab. Du kannst während deines Zuges nur 1 Stadionkarte spielen. Lege sie neben die Aktive Position, und lege sie auf den Ablagestapel, wenn eine andere Stadionkarte ins Spiel gebracht wird. Eine Stadionkarte mit demselben Namen kann nicht gespielt werden."
	},
