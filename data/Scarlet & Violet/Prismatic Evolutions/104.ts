...
const card: Card = {
	...
	effect: {
		...
		de: "Durchsuche dein Deck nach 2 Karten, mische dein Deck und lege jene Karten anschließend in beliebiger Reihenfolge auf dein Deck. Du kannst während deines Zuges nur 1 Unterstützerkarte spielen."
	},
