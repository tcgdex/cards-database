...
const card: Card = {
	...
	effect: {
		...
		de: "Du kannst nicht mehr als 1 ASS-KLASSE-Karte in deinem Deck haben. Verhindere allen Schaden, der Pokémon (deinen und denen deines Gegners), die kein Regelfeld haben, durch Attacken von Pokémon-ex und Pokémon-V des Gegners zugefügt wird. (Pokémon-ex, Pokémon-V usw. haben Regelfelder.) Diese Karte kann nicht aus dem Ablagestapel auf deine Hand genommen oder in dein Deck gelegt werden. Du kannst während deines Zuges nur 1 Stadionkarte spielen. Lege sie neben die Aktive Position, und lege sie auf den Ablagestapel, wenn eine andere Stadionkarte ins Spiel gebracht wird. Eine Stadionkarte mit demselben Namen kann nicht gespielt werden."
	},
