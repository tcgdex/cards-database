...
const card: Card = {
	...
	effect: {
		en: "The Ancient Pokémon this card is attached to gets +60 HP, recovers from all Special Conditions, and can't be affected by any Special Conditions.",
		fr: "Le Pokémon Temps passé auquel cette carte est attachée reçoit +60 PV, guérit de tous les États Spéciaux et ne peut être affecté par aucun État Spécial.",
