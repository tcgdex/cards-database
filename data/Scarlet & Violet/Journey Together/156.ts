...
const card: Card = {
	...
	effect: {
		...
		de: "Zähle deine Preiskarten, mische sie und lege sie unter dein Deck. Nimm anschließend genauso viele Karten von deinem Deck und lege sie als deine verdeckten Preiskarten ab. Du kannst während deines Zuges beliebig viele Itemkarten spielen.",
