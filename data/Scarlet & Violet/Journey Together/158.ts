...
const card: Card = {
	...
	effect: {
		...
		de: "Heile 60 Schadenspunkte bei 1 deiner Pokémon. Wenn du auf diese Weise Schaden geheilt hast, lege 1 Energie von jenem Pokémon auf deinen Ablagestapel. Du kannst während deines Zuges beliebig viele Itemkarten spielen.",
