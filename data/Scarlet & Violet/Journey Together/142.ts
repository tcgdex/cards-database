...
const card: Card = {
	...
	effect: {
		...
		de: "Ziehe 2 Karten. Wenn du anschließend 10 oder mehr Karten auf deiner Hand hast, ziehe 2 Karten mehr. Du kannst während deines Zuges nur 1 Unterstützerkarte spielen.",
