...
const card: Card = {
	...
	effect: {
		...
		de: "Lege 1 Pokémon-Ausrüstung und 1 Spezial-Energie von 1 Pokémon deines Gegners auf seinen Ablagestapel. Du kannst während deines Zuges nur 1 Unterstützerkarte spielen.",
