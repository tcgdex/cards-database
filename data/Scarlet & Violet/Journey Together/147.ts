...
const card: Card = {
	...
	effect: {
		...
		de: "Durchsuche dein Deck nach bis zu 2 Basis-Hops-Pokémon und lege sie auf deine Bank. Mische anschließend dein Deck. Du kannst während deines Zuges beliebig viele Itemkarten spielen.",
