...
const card: Card = {
	...
	abilities: [{
		...
		effect: {
			...
			pt: "Uma vez durante o seu turno, se este Pokémon estiver no Campo Ativo, você poderá procurar por até 2 cartas de Energia Water Básica no seu baralho, revelá-las e colocá-las na sua mão. Em seguida, embaralhe o seu baralho.",
	...
	attacks: [{
		...
		effect: {
			...
			pt: "Você pode descartar qualquer quantidade de Energia Water dos seus Pokémon. Este ataque causa 60 pontos de dano para cada carta descartada desta forma.",
