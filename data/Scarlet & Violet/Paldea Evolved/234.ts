...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			...
			pt: "Escolha até 3 dos seus Pokémon no Banco. Para cada um daqueles Pokémon, procure por uma carta de Energia Fire Básica no seu baralho e ligue-a àquele Pokémon. Em seguida, embaralhe o seu baralho.",
