...
const card: Card = {
	...
	name: {
		fr: "Transfert de Léo",
		en: "Bill's Transfer",
		es: "Transferencia de Bill",
		it: "Trasferimento di Bill",
		pt: "Transferência do Bill",
		de: "Bills Transfer"
	},
	...
	effect: {
		fr: "Regardez les 8 cartes du dessus de votre deck. Vous pouvez montrer le nombre voulu de Pokémon que vous y trouvez, puis les ajouter à votre main. Mélangez les autres cartes avec votre deck.",
		en: "Look at the top 8 cards of your deck. You may reveal any number of Pokémon you find there and put them into your hand. Shuffle the other cards back into your deck.",
