...
const card: Card = {
	...
	name: {
		fr: "Invitation d'Erika",
		en: "Erika's Invitation",
		es: "Invitación de Erika",
		it: "Invito di Erika",
		pt: "Convite da Érica",
		de: "Erikas Einladung"
	},
	...
	effect: {
		fr: "Votre adversaire montre sa main, puis vous placez un Pokémon de base que vous y trouvez sur le Banc de l'adversaire. Si vous placez un Pokémon sur son Banc de cette façon, envoyez ce Pokémon-là sur le Poste Actif.",
		en: "Your opponent reveals their hand, and you put a Basic Pokémon you find there onto your opponent's Bench. If you put a Pokémon onto their Bench in this way, switch in that Pokémon to the Active Spot.",
