...
const card: Card = {
	...
	effect: {
		fr: "Jouez cette carte comme si c'était un Pokémon Incolore de base avec 60 PV. Cette carte ne peut être affectée par aucun État Spécial, et elle ne peut pas battre en retraite.",
