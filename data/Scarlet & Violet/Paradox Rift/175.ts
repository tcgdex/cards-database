...
const card: Card = {
	...
	effect: {
		...
		de: "Wenn diese Karte bei der Spielvorbereitung auf deiner Hand ist, kannst du sie verdeckt in die Aktive Position oder auf deine Bank legen, als ob sie ein Basis-{C}-Pokémon mit 120 KP wäre. (Du kannst dies nur bei der Spielvorbereitung machen.) Du kannst diese Karte jederzeit während deines Zuges aus dem Spiel nehmen und auf deinen Ablagestapel legen. Diese Karte kann von keinen Speziellen Zuständen betroffen werden und sich nicht zurückziehen. Wenn diese Karte kampfunfähig wird, kann dein Gegner dafür keine Preiskarten nehmen. Du kannst während deines Zuges beliebig viele Itemkarten spielen."
	},
