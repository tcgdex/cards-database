...
const card: Card = {
	...
	effect: {
		en: "The Future Pokémon this card is attached to has no Retreat Cost, and the attacks it uses do 20 more damage to your opponent's Active Pokémon (before applying Weakness and Resistance).",
		fr: "Le Pokémon Temps futur auquel cette carte est attachée n'a pas de Coût de Retraite, et les attaques utilisées par ce Pokémon infligent 20 dégâts supplémentaires au Pokémon Actif de votre adversaire (avant application de la Faiblesse et de la Résistance).",
