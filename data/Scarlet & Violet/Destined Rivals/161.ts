...
const card: Card = {
	...
	effect: {
		...
		de: "Heile 30 Schadenspunkte bei deinem Aktiven Pokémon. Wenn jenes Pokémon ein Peppers Pokémon ist, heile bei ihm stattdessen 100 Schadenspunkte. Du kannst während deines Zuges beliebig viele Itemkarten spielen.",
