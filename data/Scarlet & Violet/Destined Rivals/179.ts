...
const card: Card = {
	...
	effect: {
		...
		de: "Wirf 1 Münze. Lege bei Kopf 2 Schadensmarken auf 1 Pokémon deines Gegners. Lege bei Zahl 2 Schadensmarken auf dein Aktives Pokémon. Du kannst während deines Zuges beliebig viele Itemkarten spielen.",
