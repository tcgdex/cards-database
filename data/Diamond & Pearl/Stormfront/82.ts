...
const card: Card = {
	...
	effect: {
		...
		de: "Diese Karte bleibt im Spiel, wenn du sie spielst. Lege diese Karte ab, sobald eine weitere Stadion-Karte ins Spiel kommt. Wenn eine andere Karte mit dem gleichen Namen im Spiel ist, kannst du diese Karte nicht spielen. Einmal während seines Zuges kann jeder Spieler 1 Münze werfen. Bei „Kopf“ durchsucht dieser Spieler seinen Ablagestapel nach 1 {L}- oder {M}-Energiekarte, zeigt sie seinem Gegner und nimmt sie auf die Hand.",
	},
