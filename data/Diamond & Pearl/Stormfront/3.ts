	...
	abilities: [
		{
			...
			effect: {
				...
				de: "Einmal während deines Zuges (vor deinem Angriff) kannst du, wenn du Panferno von deiner Hand spielst, um 1 deiner Pokémon zu entwickeln, 1 Münze werfen. Bei „Kopf“ durchsuche dein Deck nach bis zu 4 {R}-Energiekarten und lege sie in beliebiger Verteilung an deine Pokémon an. Mische dein Deck danach."
			},
		},
	],
	...
	attacks: [
		...
		},
		{
			...
			effect: {
				...
				de: "Lege 2 an Panferno angelegte {R}-Energien auf deinen Ablagestapel und dieser Angriff fügt jedem Pokémon auf der Bank deines Gegners 20 Schadenspunkte zu. (Wende Schwäche und Resistenz bei Pokémon auf der Bank nicht an.)"
			},
			damage: 80,
