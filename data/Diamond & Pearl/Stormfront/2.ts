	...
	abilities: [
		{
			...
			effect: {
				...
				de: "Einmal während deines Zuges (vor deinem Angriff) kannst du, wenn du Impoleon von deiner Hand spielst, um 1 deiner Aktiven Pokémon zu entwickeln, diese Poké-Power benutzen. Dein Gegner kann in seinem nächsten Zug keine Energiekarten von seiner Hand an seine Pokémon anlegen."
			},
		},
	],
