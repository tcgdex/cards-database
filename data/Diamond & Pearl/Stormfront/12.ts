	...
	attacks: [
		{
			...
			effect: {
				...
				de: "Dieser Angriff fügt jedem Pokémon auf der Bank deines Gegners, außer {G}- und {W}-Pokémon, 20 Schadenspunkte zu. (Wende Schwäche und Resistenz bei Pokémon auf der Bank nicht an.)"
			},
			damage: 20,
