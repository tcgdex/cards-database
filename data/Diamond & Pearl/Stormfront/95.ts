...
const card: Card = {
	...
	effect: {
		...
		de: "Verkrümmungs-Energie liefert {C}-Energie. Wenn du diese Karte von deiner Hand an dein Aktives Pokémon anlegst, tausche dieses Pokémon gegen 1 Pokémon auf deiner Bank aus."
	},
