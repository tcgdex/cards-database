	...
	attacks: [
		...
		},
		{
			...
			effect: {
				...
				de: "Lege auf jedes Pokémon deines Gegners für jede {C}-Energie in seinen Rückzugskosten (nachdem Effekte auf die Rückzugskosten verrechnet wurden) 1 Schadensmarke."
			},
