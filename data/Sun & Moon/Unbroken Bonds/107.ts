	...
	attacks: [
		{
			...
			effect: {
				...
				de: "Diese Attacke fügt 30 Schadenspunkte mehr mal der Anzahl der an alle deine Pokémon angelegten {D}-Energien zu."
			},
			damage: "30+",
