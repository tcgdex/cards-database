...
const card: Card = {
	...
	effect: {
		...
		fr: "Lorsqu'un Pokémon Obscurité (le vôtre ou celui de votre adversaire) auquel de l'Énergie Obscurité est attachée est mis K.O. par les dégâts d'une attaque d'un adversaire, ce joueur récupère une carte Récompense de moins.",
