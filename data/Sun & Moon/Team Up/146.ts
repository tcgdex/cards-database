...
const card: Card = {
	...
	effect: {
		...
		de: "Wähle 1 aus: Ziehe 1 Karte. Du kannst während deines Zuges (bevor du angreifst) beliebig viele Itemkarten spielen. Nimm 1 Richter-Karte aus deinem Ablagestapel auf deine Hand."
	},
