...
const card: Card = {
	...
	effect: {
		fr: "À la fin de ce tour, si vous avez 3 cartes ou plus dans votre main, mélangez des cartes de votre main avec votre deck jusqu'à avoir 2 cartes dans votre main.",
