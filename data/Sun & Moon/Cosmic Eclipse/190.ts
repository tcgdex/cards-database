	...
	attacks: [
		{
			...
			effect: {
				...
				fr: "Défaussez toute l'Énergie de base de ce Pokémon. Cette attaque inflige 80 dégâts pour chaque carte défaussée de cette façon. (Vous ne pouvez utiliser qu'une attaque GX par partie.)",
			},
			cost: [
				"Colorless",
				"Colorless",
