...
const card: Card = {
	...
	effect: {
		fr: "Lorsque vous jouez cette carte, vous pouvez défausser 3 autres cartes de votre main. Dans ce cas, chaque joueur défausse ses Pokémon de Banc jusqu'à avoir 3 Pokémon de Banc. Votre adversaire défausse en premier.",
