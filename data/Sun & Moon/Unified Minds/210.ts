...
const card: Card = {
	...
	effect: {
		fr: "Jouez cette carte comme si c'était un Pokémon Incolore de base avec 60 PV. N'importe quand pendant votre tour (avant votre attaque), vous pouvez défausser cette carte du jeu.",
