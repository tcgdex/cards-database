...
const card: Card = {
	...
	effect: {
		...
		'es-es': "Lanza una moneda. Si sale cara, pon 1 de tus Pokémon y todas las cartas unidas a él en tu mano.",
		'it-it': "Lancia una moneta. Se esce testa, riprendi in mano uno dei tuoi Pokémon e tutte le carte a esso assegnate.",
		'pt-br': "Jogue uma moeda. Se sair cara, coloque 1 dos seus Pokémon e todos os cards ligados a ele em sua mão.",
