	...
	abilities: [
		{
			...
			effect: {
				...
				'es-es': "En cualquier momento entre turnos, si este Pokémon es tu Pokémon Activo, pon 1 contador de daño en cada uno de los Pokémon de tu rival.",
				'it-it': "Tra un turno e l’altro, in qualsiasi momento, se questo Pokémon è il tuo Pokémon attivo, metti un segnalino danno su ciascuno dei Pokémon del tuo avversario.",
				'pt-br': "A qualquer momento entre as vezes de jogar, se este Pokémon for seu Pokémon Ativo, coloque 1 marcador de danos em cada um dos Pokémon do seu oponente.",
				'de-de': "Ist dieses Pokémon dein Aktives Pokémon, lege zu einem beliebigen Zeitpunkt zwischen den Zügen 1 Schadensmarke auf jedes Pokémon deines Gegners."
			},
		},
	],
