...
const card: Card = {
	...
	effect: {
		...
		'es-es': "Descarta 2 cartas de tu mano. (Si no puedes descartar 2 cartas, no puedes jugar esta carta.) Busca en tu baraja un Pokémon, enséñalo y ponlo en tu mano. Baraja las cartas de tu baraja después.",
		...
		'pt-br': "Descarte 2 cards da sua mão. (Se você não puder descartar 2 cards, não jogue este card.) Procure um Pokémon em seu baralho, revele-o e coloque-o na sua mão. Em seguida, embaralhe seus cards.",
