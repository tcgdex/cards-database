...
const card: Card = {
	...
	effect: {
		...
		'pt-br': "Descarte 2 cards de sua mão. (Caso você não possa descartar 2 cards, não pode jogar este card.) Procure um Pokémon em seu baralho, revele-o e coloque-o em sua mão. Em seguida, embaralhe seus cards.",
