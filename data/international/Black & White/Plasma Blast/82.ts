...
const card: Card = {
	...
	effect: {
		...
		'it-it': "Guarda le ultime sette carte del tuo mazzo. Puoi mostrare un Archen che hai trovato e metterlo nella tua panchina. Poi rimischia le altre carte nel tuo mazzo.",
		'pt-br': "Olhe os últimos 7 cards da base de seu baralho. Você pode revelar um Archen encontrado ali e colocá-lo em seu Banco. Embaralhe os outros cards de volta em seu baralho.",
