...
const card: Card = {
	...
	description: {
		'en-us': "Capable of copying an enemy's genetic code to instantly transform itself into a duplicate of the enemy.",
