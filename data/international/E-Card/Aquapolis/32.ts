	...
	attacks: [
		{
			...
			effect: {
				...
				'de-de': "Bevor Schaden zugefügt wird, kannst du 1 Popkémon auf der Bank deines Gegners wählen, auf dem keine Schadensmarken liegen, und es mit dem Verteidigenden Pokémon austauschen."
			},
			damage: 20,
		...
		},
		{
			...
			effect: {
				...
				'de-de': "Wirf so viele Münzen, wie -Energie an Scherox angelegt ist. Dieser Angriff fügt 30 Schadenspunkte plus 20 weitere Schadenspunkte pro geworfenem 'Kopf' zu."
			},
			damage: "30+",
