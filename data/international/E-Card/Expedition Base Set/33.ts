	...
	attacks: [
		{
			...
			name: {
				'en-us': "Syncroblast",
				'fr-fr': "Syncroblast",
				'de-de': "Synchronexplosion"
			},

			effect: {
				'en-us': "If Alakazam and the Defending Pokémon don't have the same number of Energy cards attached to them, this attack's base damage is 20 instead of 80.",
				'fr-fr': "Si Alakazam et le Pokémon Défenseur n'ont pas le même nombre de cartes Énergie attachées à eux, cette attaque inflige 20 dégâts de base au lieu de 80.",
				'de-de': "Wenn an Simsala und das Verteidigende Pokémon nicht dieselbe Anzahl von Energiekarten angelegt ist, ist der Basisschaden dieses Angriffs 20 anstatt 80."
			},
