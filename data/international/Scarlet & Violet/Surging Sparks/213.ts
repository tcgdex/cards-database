...
const card: Card = {
	...
	abilities: [{
		...
		name: {
			'en-us': "Expert Hider",
			'fr-fr': "Expert en Camouflage",
			'es-es': "As del Camuflaje",
			'it-it': "Specialista di Nascondigli",
			'pt-br': "Mestre da Camuflagem",
			'de-de': "Verbergungskünstler"
		},
	...
	attacks: [{
		...
		name: {
			'en-us': "Lick Whip",
			'fr-fr': "Fouet Léchouille",
			'es-es': "Latigazo Lingual",
			'it-it': "Leccafrusta",
			'pt-br': "Chicote de Língua",
			'de-de': "Schleckerpeitsche"
		},
