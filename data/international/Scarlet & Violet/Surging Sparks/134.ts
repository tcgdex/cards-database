...
const card: Card = {
	...
	attacks: [{
		...
		name: {
			'en-us': "Humming Charge",
			'fr-fr': "Charge Virevolte",
			'es-es': "Carga Cantarina",
			'it-it': "Carica Canterina",
			'pt-br': "Canto Abastecedor",
			'de-de': "Aufladendes Gesumme"
		},
		...
		name: {
			'en-us': "Cotton Wings",
			'fr-fr': "Ailes de Coton",
			'es-es': "Alas Algodonadas",
			'it-it': "Ali di Cotone",
			'pt-br': "Asas de Algodão",
			'de-de': "Watteschwingen"
		},
