...
const card: Card = {
	...
	abilities: [{
		...
		name: {
			'en-us': "Semi-Blooming Energy",
			'fr-fr': "Énergie Semi-Florissante",
			'es-es': "Floración Parcial de Energía",
			'it-it': "Energia in Germoglio",
			'pt-br': "Energia Semiflorescida",
			'de-de': "Halb blühende Energie"
		},
