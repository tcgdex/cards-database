...
const card: Card = {
	...
	abilities: [{
		...
		name: {
			'en-us': "Plume Protection",
			'fr-fr': "Protection Plume",
			'de-de': "Federschutz",
			'it-it': "Piumadifesa",
			'pt-br': "Proteção Plumosa",
			'es-es': "Protección Plumífera",
			'es-mx': "Pluma Protectora"
		},

		effect: {
			'en-us': "As long as this Pokémon is on your Bench, prevent all damage done to this Pokémon by attacks from your opponent's Pokémon.",
			'fr-fr': "Tant que ce Pokémon est sur votre Banc, évitez tous les dégâts infligés à ce Pokémon par les attaques des Pokémon de votre adversaire.",
			'de-de': "Solange sich dieses Pokémon auf deiner Bank befindet, verhindere allen Schaden, der diesem Pokémon durch Attacken von Pokémon deines Gegners zugefügt wird.",
			'it-it': "Fintanto che questo Pokémon è nella tua panchina, previeni tutti i danni inflitti a questo Pokémon dagli attacchi dei Pokémon del tuo avversario.",
			'pt-br': "Enquanto este Pokémon estiver no seu Banco, previna todo o dano causado a este Pokémon por ataques dos Pokémon do seu oponente.",
			'es-es': "Mientras este Pokémon esté en tu Banca, se evita todo el daño infligido a este Pokémon por ataques de los Pokémon de tu rival.",
