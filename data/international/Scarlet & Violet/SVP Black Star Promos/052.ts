...
const card: Card = {
	...
	attacks: [{
		...
		name: {
			'en-us': "Reflective Barrier",
			'fr-fr': "Bouclier Réfléchissant",
			'es-es': "Barrera Reflectante",
			'it-it': "Barriera Riflettente",
			'pt-br': "Barreira Reflexiva",
			'de-de': "Reflektive Barriere"
		},
		...
		effect: {
			...
			'fr-fr': "Pendant le prochain tour de votre adversaire, si ce Pokémon subit les dégâts d'une attaque (même s'il est mis K.O.), placez des marqueurs de dégâts sur le Pokémon Attaquant équivalents aux dégâts infligés à ce Pokémon.",
		...
		name: {
			'en-us': "Psyslash",
			'fr-fr': "Psykochoc",
			'es-es': "Golpe Psíquico",
			'it-it': "Psicocolpo",
			'pt-br': "Pancada Psíquica",
			'de-de': "Psy-Schlitzer"
		},
