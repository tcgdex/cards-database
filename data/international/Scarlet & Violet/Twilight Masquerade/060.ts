...
const card: Card = {
	...
	abilities: [{
		...
		name: {
			'en-us': "Zero to Hero",
			'fr-fr': "Supermutation",
			'es-es': "Cambio Heroico",
			'it-it': "Supercambio",
			'pt-br': "Do Abismo ao Heroísmo",
			'de-de': "Superwechsel"
		},
	...
	description: {
		'en-us': "Its physical capabilities are no different than a Finizen's, but when its allies are in danger, it transforms and powers itself up.",
	},
