...
const card: Card = {
	...
	name: {
		'en-us': "Technical Machine: Devolution",
		'fr-fr': "Capsule Technique : Dés-Évolution",
		'es-es': "Máquina Técnica: Involución",
		'it-it': "Macchinario Tecnico: Involuzione",
		'pt-br': "Máquina Técnica: Involução",
		'de-de': "Technische Maschine: Rückentwicklung"
	},
	...
	attacks: [{
		...
		name: {
			...
			'it-it': "Involuzione",
			'pt-br': "Involução",
			'de-de': "Rückentwicklung"
		},

		effect: {
			'en-us': "Devolve each of your opponent's evolved Pokémon by putting the highest Stage Evolution card on it into your opponent's hand.",
			'fr-fr': "Faites dés-évoluer chacun des Pokémon évolués de votre adversaire en plaçant dans la main de votre adversaire la carte Évolution la plus élevée placée sur ceux-ci.",
			'es-es': "Involuciona a cada uno de los Pokémon evolucionados de tu rival poniendo la carta de Evolución de fase más alta que tengan sobre ellos en la mano de tu rival.",
			'it-it': "Annulla l'evoluzione di ciascuno dei Pokémon evoluti del tuo avversario prendendo la carta Evoluzione di fase più alta presente su di esso e aggiungendola alle carte nella mano del tuo avversario.",
			'pt-br': "Reverta a evolução de cada um dos Pokémon evoluídos do seu oponente colocando a carta de Evolução de Estágio mais alto sobre ele na mão do seu oponente.",
			'de-de': "Rückentwickle jedes entwickelte Pokémon deines Gegners, indem du deinem Gegner die daraufliegende Karte mit der höchsten Entwicklungsphase auf die Hand gibst."
		}
	}],
