...
const card: Card = {
	...
	attacks: [{
		...
		name: {
			'en-us': "Whirltide",
			'fr-fr': "Marée Tourbillonnante",
			'es-es': "Marea Remolino",
			'it-it': "Marea Vorticosa",
			'pt-br': "Redemoinho de Maré",
			'de-de': "Gezeitenwirbel"
		},

		effect: {
			'en-us': "Reveal the top 6 cards of your deck. This attack does 60 damage to 1 of your opponent's Pokémon for each Energy card you find there. Then, discard those Energy cards and shuffle the other cards back into your deck. (Don't apply Weakness and Resistance for Benched Pokémon.)",
			...
			'es-es': "Enseña las 6 primeras cartas de tu baraja. Este ataque hace 60 puntos de daño a uno de los Pokémon de tu rival por cada carta de Energía que encuentres entre ellas. Después, descarta esas cartas de Energía, pon el resto de las cartas de nuevo en tu baraja y barájalas todas. (No apliques Debilidad y Resistencia a los Pokémon en Banca).",
			'it-it': "Mostra le prime sei carte del tuo mazzo. Questo attacco infligge 60 danni a uno dei Pokémon del tuo avversario per ogni carta Energia presente tra quelle carte. Poi scarta quelle carte Energia e rimischia le altre carte nel tuo mazzo. Non applicare debolezza e resistenza ai Pokémon in panchina.",
			'pt-br': "Revele as 6 cartas de cima do seu baralho. Este ataque causa 60 pontos de dano a 1 dos Pokémon do seu oponente para cada carta de Energia que encontrar lá. Em seguida, descarte aquelas cartas de Energia e embaralhe as outras cartas de volta no seu baralho. (Não aplique Fraqueza e Resistência aos Pokémon no Banco.)",
	...
	description: {
		'en-us': "Scales shed by this Pokémon have such a splendorous gleam to them that they've been given to royalty as gifts.",
	},
