...
const card: Card = {
	...
	name: {
		'en-us': "Technical Machine: Blindside",
		'fr-fr': "Capsule Technique : Angle Mort",
		'es-es': "Máquina Técnica: Lado Ciego",
		'it-it': "Macchinario Tecnico: Spiazzare",
		'pt-br': "Máquina Técnica: Ponto Cego",
		'de-de': "Technische Maschine: Aus heiterem Himmel"
	},
	...
	attacks: [{
		...
		effect: {
			...
			'es-es': "Este ataque hace 100 puntos de daño a uno de los Pokémon de tu rival que tenga algún contador de daño sobre él. (No apliques Debilidad y Resistencia a los Pokémon en Banca).",
