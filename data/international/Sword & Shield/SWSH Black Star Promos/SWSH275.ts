...
const card: Card = {
	...
	attacks: [{
		...
		name: {
			'fr-fr': "Courants Extracteurs",
			'de-de': "Reißende Strömung",
			'es-es': "Corrientes de Tracción",
			'pt-br': "Maré Arrastadora",
			'it-it': "Correnti Trainanti",
			'en-us': "Pulling Currents"
		},
		...
		effect: {
			...
			'pt-br': "Seu oponente revela a própria mão. Coloque até 2 Pokémon Básicos que encontrar lá no Banco do seu oponente.",
			'it-it': "Il tuo avversario mostra le carte che ha in mano. Prendi fino a due Pokémon Base presenti tra quelle carte e mettili nella sua panchina.",
