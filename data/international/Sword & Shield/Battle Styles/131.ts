...
const card: Card = {
	...
	name: {
		'en-us': "Rapid Strike Scroll of Swirls",
		'fr-fr': "Rouleau Tourbillons Mille Poings",
		'es-es': "Pergamino Vorágine Golpe Fluido",
		'it-it': "Rotolo dei Vortici Colpo Rapido",
		'pt-br': "Pergaminho de Turbilhão Golpe Fluido",
		'de-de': "Fließender-Angriff-Wirbelrolle"
	},
