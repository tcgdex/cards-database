	...
	attacks: [
		{
			...
			effect: {
				'en-us': "Does 10 damage plus 10 more damage for each Energy attached to Deoxys ex and the Defending Pokémon.",
				'fr-fr': "Inflige 10 dégâts plus 10 dégâts pour chaque Énergie attachée à Deoxys ex et au Pokémon Défenseur.",
				'de-de': "Does 10 damage plus 10 more damage for each Energy attached to Deoxys ex and the Defending Pokémon."
			},
			damage: "10+",
