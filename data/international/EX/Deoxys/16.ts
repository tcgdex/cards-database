	...
	attacks: [
		{
			...
			effect: {
				'en-us': "If Deoxys and the Defending Pokémon have a different amount of Energy attached to them, this attack's base damage is 20 instead of 40.",
				'fr-fr': "Si Deoxys et le Pokémon Défenseur ont un total d'Énergie différent, les dégâts de base de cette attaque sont de 20 et non de 40.",
				'de-de': "If Deoxys and the Defending Pokémon have a different amout of Energy attached to them, this attack's base damage is 20 instead 40."
			},
			damage: 40,
