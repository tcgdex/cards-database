	...
	attacks: [
		{
			...
			name: {
				'en-us': "Crystal Laser",
				'fr-fr': "Laser de cristal",
				'de-de': "Kristall-Laser"
			},
			effect: {
				'en-us': "During your next turn, Deoxys's attacks do 40 more damage to the Defending Pokémon (before applying Weakness and Resistance).",
				'fr-fr': "Lors de votre prochain tour, les attaques de Deoxys infligent 40 dégâts supplémentaires au Pokémon Défenseur (avant application de la Faiblesse et de la Résistance).",
				'de-de': "In deinem nächsten Zuges fügen die Angriffe von Deoxys dem Verteidigendem Pokémon 40 zusätzliche Schadenspunkte zu (bevor Schwäche und Resistenz verrechnet wurden)."
			},
			damage: 20,
