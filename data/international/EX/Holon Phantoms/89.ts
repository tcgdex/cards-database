...
const card: Card = {
	...
	effect: {
		...
		'fr-fr': "Lancez une pièce. Si c'est face, piochez les 3 cartes du dessous de votre deck. Si c'est pile, piochez les 2 cartes du dessus de votre deck.",
		'de-de': "Wirf 1 Münze. Ziehe bei \"Kopf\" die untersten 3 Karten deines Decks. Ziehe bei \"Zahl\" die obersten 2 Karten deines Decks.",
	},
