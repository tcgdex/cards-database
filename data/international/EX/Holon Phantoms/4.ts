	...
	attacks: [
		{
			...
			effect: {
				'en-us': "During your opponent's next turn, any damage done to Deoxys by attacks is reduced by 30 (before applying Weakness and Resistance).",
				'fr-fr': "Lors du prochain tour de votre adversaire, tous dégâts infligés à Deoxys par des attaques sont réduits de 30 (avant application de la Faiblesse et de la Résistance).",
				'de-de': "Während des nächsten Zuges deines Gegners wird jeder Schaden, der Deoxys durch Angriffe zugefügt wird, um 30 Schadenspunkte reduziert (bevor Schwäche und Resistenz verrechnet wurden)."
			},
			damage: 30,
