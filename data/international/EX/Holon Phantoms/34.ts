	...
	attacks: [
		...
		},
		{
			...
			effect: {
				...
				'fr-fr': "Lancez 3 pièces. Si vous obtenez 1 face, cette attaque inflige 10 dégâts plus 10 dégâts supplémentaires. Si vous obtenez 2 faces, cette attaque inflige 10 dégâts plus 20 dégâts supplémentaires. Si vous n'obtenez que des faces, cette attaque inflige 10 dégâts plus 40 dégâts supplémentaires.",
