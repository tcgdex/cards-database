	...
	attacks: [
		{
			...
			name: {
				'en-us': "Holon Splash",
				'fr-fr': "Éclaboussure Holon",
				'de-de': "Holon-Platscher"
			},
			effect: {
				'en-us': "Does 30 damage plus 10 more damage for each Holon Energy card attached to Rain Castform.",
				'fr-fr': "Inflige 30 dégâts plus 10 dégâts supplémentaires pour chaque carte Énergie Holon attachée à Morpheo Pluie.",
				'de-de': "Fügt 30 Schadenspunkte plus 10 zusätzliche Schadenspunkte für jede an Regen-Formeo angelegte Holon-Energiekarte zu."
			},
			damage: "30+",
