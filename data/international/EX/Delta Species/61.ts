	...
	attacks: [
		{
			...
			effect: {
				'en-us': "Flip a coin. If tails, discard a Fire Energy card attached to Ditto.",
				'fr-fr': "Lancez une pièce. Si c'est pile, défaussez une carte Énergie  attachée à Metamorph.",
				'de-de': "Flip a coin. If tails, discard a  Energy card attached to Ditto."
			},
			damage: 30,
