	...
	attacks: [
		{
			...
			effect: {
				'en-us': "Search your discard pile for an Energy card and attach it to Ditto.",
				'fr-fr': "Choisissez dans votre pile de défausse une carte Énergie et attachez-la à Metamorph.",
				'de-de': "Search your discard pile for an Energy card and attach it to Ditto."
			},
			damage: 10,
