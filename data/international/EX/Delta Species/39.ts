	...
	attacks: [
		{
			...
			effect: {
				'en-us': "Discard all Energy cards attached to Ditto.",
				'fr-fr': "Défaussez toutes les cartes Énergie attachées à Metamorph.",
				'de-de': "Discard all Energy cards attached to Ditto."
			},
			damage: 40,
