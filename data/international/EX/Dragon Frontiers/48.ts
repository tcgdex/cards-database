	...
	abilities: [
		{
			...
			effect: {
				...
				'de-de': "Einmal während deines Zuges (vor deinem Angriff) kannst du Elektek von deiner Hand auf Elekid legen (das zählt als Entwickeln von Elekid) und alle Schadensmarken von Elekid entfernen."
			},
		},
	],
