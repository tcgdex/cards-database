...
const card: Card = {
	name: {
		'en-us': "Gardevoir ex δ",
		'fr-fr': "Gardevoir ex δ",
		'de-de': "Guardevoir ex"
	},
	...
	attacks: [
		{
			...
			effect: {
				'en-us': "You may move a Fire Energy card attached to Gardevoir ex to 1 of your Benched Pokémon.",
				'fr-fr': "Vous pouvez déplacer une carte Énergie  attachée à Gardevoir ex sur 1 des Pokémon de votre Banc.",
				'de-de': "Du kannst eine an Guardevoir ex angelegte -Energiekarte an 1 Pokémon auf deiner Bank legen."
			},
			damage: 80,
