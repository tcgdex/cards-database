...
const card: Card = {
	...
	effect: {
		...
		'de-de': "Doppel-Regenbogen-Energie kann nur an ein entwickeltes Pokémon (außer Pokémon-ex) angelegt werden. Während Doppel-Regenbogen-Energie im Spiel ist, zählt sie als jeder beliebige Energietyp, spendet aber zwei Energien auf einmal. (Sie hat keinen Effekt, außer dass sie Energie spendet.) Schaden, der gegnerischen Pokémon durch Angriffe des Pokémon, an dem Doppel-Regenbogen-Energie angelegt ist, zugefügt wird, wird um 10 Schadenspunkte reduziert (bevor Schwäche und Resistenz verrechnet wurden). Handelt es sich bei dem Pokémon, an dem Doppel-Regenbogen-Energie angelegt ist, nicht mehr um ein entwickeltes Pokémon, lege Doppel-Regenbogen-Energie auf deinen Ablagestapel."
	},
