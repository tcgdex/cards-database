	...
	attacks: [
		{
			...
			effect: {
				...
				'fr-fr': "Choisissez dans votre deck 2 cartes Outil Pokémon et attachez-les à vos Pokémon (Pokémon possédant un Outil Pokémon exclus). Ensuite, mélangez votre deck."
			},
