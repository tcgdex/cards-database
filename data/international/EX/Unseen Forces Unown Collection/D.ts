	...
	attacks: [
		{
			...
			effect: {
				...
				'fr-fr': "Lancez une pièce. Si c'est face, choisissez 1 des Pokémon Évolués d'un joueur, retirez à ce Pokémon sa carte Évolution au niveau le plus élevé et replacez-la dans la main du joueur."
			},
