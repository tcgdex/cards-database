	...
	attacks: [
		{
			...
			effect: {
				'en-us': "Flip a coin. If heads, switch all damage counters on Unown with those on the Defending Pokémon. (If an effect of this attack is prevented, this attack does nothing.)",
				'fr-fr': "Lancez une pièce. Si c'est face, échangez tous les marqueurs de dégât placés sur Zarbi avec ceux du Pokémon Défenseur. (Si vous prévenez un effet de cette attaque, cette attaque est sans effet.)"
			},
