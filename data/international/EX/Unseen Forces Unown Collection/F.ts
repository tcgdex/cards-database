	...
	attacks: [
		{
			...
			effect: {
				'en-us': "Flip 3 coins. If 1 of them is heads, the Defending Pokémon is now Asleep. If 2 of them are heads, the Defending Pokémon is now Confused. If all of them are heads, the Defending Pokémon is now Paralyzed.",
				'fr-fr': "Lancez 3 pièces. Si 1 des pièces est face, le Pokémon Défenseur est maintenant Endormi. Si 2 des pièces sont faces, le Pokémon Défenseur est maintenant Confus. Si ce sont toutes des faces, le Pokémon Défenseur est maintenant Paralysé."
			},
			damage: 10,
