	...
	attacks: [
		{
			...
			effect: {
				'en-us': "Return Unown and all Energy cards attached to it to your hand.",
				'fr-fr': "Reprenez Zarbi et toutes les cartes Énergie qui lui sont attachées dans votre main."
			},
			damage: 20,
