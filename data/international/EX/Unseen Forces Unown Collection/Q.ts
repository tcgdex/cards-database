	...
	attacks: [
		{
			...
			effect: {
				...
				'fr-fr': "Choisissez dans votre deck jusqu'à 3 types de cartes Énergie de base différents, montrez-les à votre adversaire et placez-les dans votre main. Ensuite, mélangez votre deck."
			},
