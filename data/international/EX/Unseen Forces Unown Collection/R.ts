	...
	attacks: [
		{
			...
			effect: {
				...
				'fr-fr': "Lancez une pièce. Si c'est face, votre adversaire reprend le Pokémon Défenseur et toutes les cartes qui lui sont attachées dans sa main. (Si votre adversaire ne possède pas de Pokémon de Banc ou d'autre Pokémon Actif, cette attaque est sans effet.)"
			},
