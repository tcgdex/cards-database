	...
	attacks: [
		{
			...
			effect: {
				'en-us': "Remove 5 damage counters from Unown. (All if there are less than 5.)",
				'fr-fr': "Retirez à Zarbi 5 marqueurs de dégât. (Retirez-les lui tous s'il en a moins de 5.)"
			},
