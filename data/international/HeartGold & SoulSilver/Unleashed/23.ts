...
const card: Card = {
	...
	attacks: [
		{
			...
			effect: {
				'en-us': "Does 20 damage times the amount of Energy attached to Roserade.",
				'fr-fr': "Inflige 20 dégâts multipliés par le nombre de cartes Énergie attachées à Roserade.",
				'de-de': "Dieser Angriff fügt 20 Schadenspunkte mal der Anzahl der an Roserade angelegten Energien zu."
			},
			damage: "20×",
	...
	description: {
		'en-us': "Its sweet aroma attracts prey. Then it spews poison. The more toxic it is, the sweeter its aroma."
	},
