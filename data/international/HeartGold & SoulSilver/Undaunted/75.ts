...
const card: Card = {
	...
	effect: {
		...
		'en-us': "Reveal the top 10 cards of your deck. If you reveal both halves of a Pokémon LEGEND, put those cards onto your Bench and attach all revealed Energy cards to that Pokémon LEGEND. Shuffle the other cards back into your deck. (You can play only 1 Pokémon LEGEND in this way.)",
		'de-de': "Decke die obersten 10 Karten deines Decks auf. Falls du beide Hälften einer Pokémon-LEGENDE aufdeckst, lege diese auf deine Bank und lege alle aufgedeckten Energiekarten an die Pokémon-LEGENDE an. Mische die anderen Karten anschließend in dein Deck. (Auf diese Art kannst du nur 1 Pokémon-LEGENDE spielen.)"
	},
