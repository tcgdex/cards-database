	...
	attacks: [
		{
			...
			name: {
				'en-us': "Primordial Boom",
				'fr-fr': "Boom Originel",
				'es-es': "Estruendo Primordial",
				'it-it': "Boato Primordiale",
				'pt-br': "Explosão Primordial",
				'de-de': "Urdonner"
			},
			effect: {
				'en-us': "If you have a Stadium card in play, this attack does 40 more damage. If your opponent has a Stadium card in play, heal 40 damage from this Pokémon.",
				'fr-fr': "Si vous avez une carte Stade en jeu, cette attaque inflige 40 dégâts supplémentaires. Si votre adversaire a une carte Stade en jeu, soignez 40 dégâts à ce Pokémon.",
				'es-es': "Si tienes alguna carta de Estadio en juego, este ataque hace 40 puntos de daño más. Si tu rival tiene alguna carta de Estadio en juego, cura 40 puntos de daño a este Pokémon.",
				'it-it': "Se hai in gioco una carta Stadio, questo attacco infligge 40 danni in più. Se il tuo avversario ha in gioco una carta Stadio, cura questo Pokémon da 40 danni.",
				'pt-br': "Se você tiver um card de Estádio em jogo, este ataque causará 40 de danos adicionais. Se o seu oponente tiver um card de Estádio em jogo, cure 40 de danos deste Pokémon.",
				'de-de': "Wenn du eine Stadionkarte im Spiel hast, fügt dieser Angriff 40 weitere Schadenspunkte zu. Wenn dein Gegner eine Stadionkarte im Spiel hat, heile 40 Schadenspunkte bei diesem Pokémon."
			},
			damage: "80+",
