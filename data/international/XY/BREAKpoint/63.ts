	...
	attacks: [
		{
			...
			effect: {
				...
				'pt-br': "Jogue uma moeda. Se sair cara, todos os efeitos dos ataques a este Pokémon serão previnidos, inclusive danos, durante a próxima vez de jogar do seu oponente.",
