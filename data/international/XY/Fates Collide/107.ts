...
const card: Card = {
	...
	effect: {
		...
		'es-es': "Busca en tu baraja hasta 2 Pokémon Básicos, enséñalos y ponlos en tu mano. Baraja las cartas de tu baraja después.",
		...
		'pt-br': "Procure em seu baralho até 2 Pokémon Básicos, revele-os e coloque-os na sua mão. Em seguida, embaralhe seus cards.",
