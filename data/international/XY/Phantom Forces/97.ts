...
const card: Card = {
	name: {
		...
		es: "Casco Resonante Hiperequipo del Team Flare",
		it: "Casco Sonoro [Dotazione Extra del Team Flare]",
		pt: "Campainha de Cabeça – Hiperequipamento da Equipe Flare",
		de: "Kopfgeschirr Team Flare-Superzubehör"
	},
