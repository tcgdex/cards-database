...
const card: Card = {
	...
	abilities: [{
		...
		name: {
			'en-us': "Final Chain",
			'fr-fr': "Dernière Chaîne",
			'es-es': "Última Cadena",
			'es-mx': "Última Cadena",
			'de-de': "Letzte Kette",
			'it-it': "Ultima Catena",
			'pt-br': "Corrente Final"
		},
		...
		effect: {
			...
			'it-it': "Se questo Pokémon viene messo KO dai danni inflitti da un attacco di un Pokémon del tuo avversario, cerca nel tuo mazzo una carta e aggiungila a quelle che hai in mano. Poi rimischia il tuo mazzo.",
	...
	attacks: [{
		...
		name: {
			'en-us': "Mochi Rush",
			'fr-fr': "Ruée Mochi",
			'es-es': "Embestida de Mochis",
			'es-mx': "Asalto Mochi",
			'de-de': "Mochi-Offensive",
			'it-it': "Raffica di Mochi",
			'pt-br': "Moti aos Montes"
		},

		effect: {
			'en-us': "During your next turn, this Pokémon's Mochi Rush attack does 50 more damage (before applying Weakness and Resistance).",
			'fr-fr': "Pendant votre prochain tour, l'attaque Ruée Mochi de ce Pokémon inflige 50 dégâts supplémentaires (avant application de la Faiblesse et de la Résistance).",
			'es-es': "Durante tu próximo turno, el ataque Embestida de Mochis de este Pokémon hace 50 puntos de daño más (antes de aplicar Debilidad y Resistencia).",
			...
			'de-de': "Während deines nächsten Zuges fügt die Attacke Mochi-Offensive dieses Pokémon 50 Schadenspunkte mehr zu (bevor Schwäche und Resistenz verrechnet werden).",
			'it-it': "Durante il tuo prossimo turno, l'attacco Raffica di Mochi di questo Pokémon infligge 50 danni in più, prima di aver applicato debolezza e resistenza.",
			'pt-br': "Durante o seu próximo turno, o ataque Moti aos Montes deste Pokémon causará 50 pontos de dano a mais (antes de aplicar Fraqueza e Resistência)."
		},
