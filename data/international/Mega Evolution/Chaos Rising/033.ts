...
const card: Card = {
	...
	attacks: [{
		name: {
			'en-us': "Psy Protection",
			'fr-fr': "Protection Psychique",
			'es-es': "Psicoprotección",
			'es-mx': "Psicoprotección",
			'de-de': "Psyschutz",
			'it-it': "Difesa Psichica",
			'pt-br': "Defesa Psíquica"
		},
		...
		effect: {
			...
			'es-es': "Durante el próximo turno de tu rival, se evita todo el daño infligido a este Pokémon por ataques de Pokémon que tengan una habilidad.",
			...
			'de-de': "Verhindere während des nächsten Zuges deines Gegners allen Schaden, der diesem Pokémon durch Attacken von Pokémon, die eine Fähigkeit haben, zugefügt wird.",
			...
			'pt-br': "Durante o próximo turno do seu oponente, previna todo o dano causado a este Pokémon por ataques de Pokémon que têm uma Habilidade."
		}
	}],
