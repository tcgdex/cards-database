...
const card: Card = {
	...
	abilities: [{
		...
		name: {
			'en-us': "Spiteful Evolution",
			'fr-fr': "Évolution Malveillante",
			'es-es': "Evolución Malévola",
			'es-mx': "Evolución Rencorosa",
			'de-de': "Tückische Entwicklung",
			'it-it': "Evoluzione Dispettosa",
			'pt-br': "Evolução Rancorosa"
		},

		effect: {
			'en-us': "Once during your turn, you may use this Ability. Choose a card in your hand that evolves from this Pokémon and put it onto this Pokémon to evolve it. If you do, place 2 damage counters on the Pokémon you evolved in this way. You can't use this Ability during your first turn.",
			...
			'es-es': "Una vez durante tu turno, puedes usar esta habilidad. Elige 1 carta de tu mano que evolucione de este Pokémon y ponla sobre este Pokémon para hacerlo evolucionar. Si lo haces, pon 2 contadores de daño en el Pokémon que hayas hecho evolucionar de esta manera. No puedes usar esta habilidad durante tu primer turno.",
