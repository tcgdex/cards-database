...
const card: Card = {
	...
	abilities: [{
		...
		name: {
			'en-us': "Intimidating Jaw",
			'fr-fr': "Mâchoire Intimidante",
			'es-es': "Mandíbula Intimidatoria",
			'es-mx': "Mandíbula Intimidante",
			'de-de': "Bedrohlicher Kiefer",
			'it-it': "Mascella Prepotente",
			'pt-br': "Mandíbula Intimidadora"
		},
