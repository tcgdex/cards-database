...
const card: Card = {
	...
	abilities: [{
		...
		name: {
			'en-us': "Protective Sail",
			'fr-fr': "Nageoire Protectrice",
			'es-es': "Aleta Protectora",
			'es-mx': "Aleta Protectora",
			'de-de': "Schützende Flosse",
			'it-it': "Pinna Protettiva",
			'pt-br': "Vela Protetora"
		},
		...
		effect: {
			...
			'fr-fr': "Chaque fois que votre adversaire joue une carte Supporter de sa main, évitez tous les effets de cette carte infligés à ce Pokémon.",
			'es-es': "Cada vez que tu rival juegue una carta de Partidario de su mano, se evitan todos los efectos de esa carta infligidos a este Pokémon.",
			...
			'de-de': "Verhindere jedes Mal, wenn dein Gegner 1 Unterstützerkarte aus seiner Hand spielt, alle Effekte jener Karte, die diesem Pokémon zugefügt werden.",
			...
			'pt-br': "Sempre que seu oponente jogar uma carta de Apoiador da mão dele, previna todos os efeitos daquela carta causados a este Pokémon."
		}
	}],
