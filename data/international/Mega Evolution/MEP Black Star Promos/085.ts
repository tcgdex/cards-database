...
const card: Card = {
	...
	abilities: [{
		...
		effect: {
			...
			'fr-fr': "Tant que ce Pokémon est sur votre Banc, évitez tous les dégâts infligés à chacun de vos Pokémon par les attaques des Pokémon de votre adversaire auxquels 2 Energies ou moins sont attachées.",
