...
const card: Card = {
	...
	effect: {
		...
		'es-es': "Si el Pokémon al que está unida esta carta no tiene un recuadro de regla, los ataques que use harán 30 puntos de daño más al Pokémon ex Activo de tu rival (antes de aplicar Debilidad y Resistencia). (Los Pokémon ex, Pokémon V, etc., tienen recuadros de regla).",
