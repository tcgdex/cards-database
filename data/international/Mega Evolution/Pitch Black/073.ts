...
const card: Card = {
	...
	name: {
		...
		'fr-fr': "Fossile Crâne Ancien",
		'es-es': "Fósil Cráneo Antiguo",
		'es-mx': "Fósil Cráneo Antiguo",
		'de-de': "Antikes Kopffossil",
		'it-it': "Vecchio Fossilcranio",
		'pt-br': "Fóssil Crânio Arcaico"
	},
	...
	abilities: [{
		...
		name: {
			'en-us': "Spiny Skull",
			'fr-fr': "Crâne Épineux",
			'es-es': "Cráneo Espinoso",
			'es-mx': "Cráneo Punzante",
			'de-de': "Stachelkopf",
			'it-it': "Cranio Appuntito",
			'pt-br': "Crânio Espinhoso"
		},
