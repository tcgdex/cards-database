...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			'en-us': "Place 5 damage counters on 1 of your opponent's Benched Pokémon.",
			'fr-fr': "Placez 5 marqueurs de dégâts sur l'un des Pokémon de Banc de votre adversaire.",
			'es-es': "Pon 5 contadores de daño en uno de los Pokémon en Banca de tu rival.",
			'es-mx': "Pon 5 contadores de daño en 1 de los Pokémon en Banca de tu rival.",
			'de-de': "Lege 5 Schadensmarken auf 1 Pokémon auf der Bank deines Gegners.",
			'it-it': "Metti cinque segnalini danno su uno dei Pokémon nella panchina del tuo avversario.",
			'pt-br': "Coloque 5 contadores de dano em 1 dos Pokémon no Banco do seu oponente."
		}
	}],
