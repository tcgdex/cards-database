...
const card: Card = {
	...
	abilities: [
		{
			type: "Poke-POWER",
			name: {
				'en-us': "Evolutionary Vitality",
				'fr-fr': "Vitalité d'évolution",
				'de-de': "Evolutionäre Lebenskraft"
			},
			effect: {
				...
				'de-de': "Einmal während deines Zuges kannst du, wenn du Tyracroc von deiner Hand spielst, um 1 deiner Pokémon zu entwickeln, dir die obersten 5 Karten deines Decks anschauen. Wähle alle Energiekarten, die du dort gefunden hast, zeige sie deinem Gegner und nimm sie auf die Hand. Lege die anderen Karten zurück auf dein Deck. Mische dein Deck danach"
			},
		},
	],
	...
	description: {
		...
		'fr-fr': "Quand il mord, il ne lâche pas prise avant que ses crocs se brisent. Ils repoussent par la suite."
	},
