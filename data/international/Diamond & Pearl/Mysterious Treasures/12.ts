	...
	attacks: [
		...
		},
		{
			...
			effect: {
				...
				'fr-fr': "Si Magby ne se trouve pas sous Maganon, défaussez 2 cartes Énergie de votre main. (Si vous ne pouvez pas défausser 2 cartes Énergie de votre main, cette attaque est sans effet.)",
