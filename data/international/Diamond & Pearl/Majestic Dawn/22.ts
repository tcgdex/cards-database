...
const card: Card = {
	...
	attacks: [
		...
		},
		{
			...
			effect: {
				'en-us': "Discard all Fire Energy attached to Infernape. This attack does 40 damage times the amount of Fire Energy you discarded.",
				'fr-fr': "Défaussez toutes les Énergies Fire attachées à Simiabraz. Cette attaque inflige 40 dégâts multipliés par le nombre d'Énergies Fire défaussées.",
				'de-de': "Lege alle an Panferno angelegten -Energien auf deinen Ablagestapel. Dieser Angriff fügt 40 Schadenspunkte mal der Anzahl der auf diese Weise auf den Ablagestapel gelegten -Energien zu."
			},
			damage: "40x",
