	...
	abilities: [
		{
			...
			effect: {
				...
				'fr-fr': "Une seule fois lors de votre tour (avant votre attaque), vous pouvez placez M. Mime de votre main sur Mime Jr. (vous le faites ainsi évoluer et retirer à Mime Jr. tous ses marqueurs de dégât.",
