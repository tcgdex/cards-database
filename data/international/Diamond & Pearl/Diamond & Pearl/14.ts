...
const card: Card = {
	...
	abilities: [
		{
			...
			name: {
				'en-us': "Darkness Fan",
				'fr-fr': "Ventilateur Obscurité",
				'de-de': "Finsterer Fächer"
			},
			effect: {
				'en-us': "Once during your turn (before your attack), you may flip a coin. If heads, choose 1 Evolved Pokémon on your opponent's Bench, remove the highest Stage Evolution card from that Pokémon, and put it back into his or her hand. This power can't be used if Shiftry is affected by a Special Condition.",
				'fr-fr': "Une seule fois lors de votre tour (avant votre attaque), si Tengalice est votre Pokémon Actif, vous pouvez lancer une pièce. Si c'est face, choisissez 1 Pokémon Évolué sur le Banc de votre adversaire, retirez-lui la carte Évolution au niveau le plus élevé et replacez-la dans sa main. Ce pouvoir ne peut pas être utilisé si Tengalice est affecté par un État Spécial.",
				'de-de': "Einmal während deines Zuges (vor deinem Angriff), wenn Tengulist dein Aktives Pokémon ist, kannst du 1 Münze werfen. Entferne die höchste Evolutionsstufe vom gewählten Pokémon. Dein Gegner nimmt diese Karte zurück auf die Hand. Diese Poke-Power kann nicht benutzt werden, wenn Tengulist von einem Speziellen Zustand betroffen ist."
			},
		},
	],
	...
	attacks: [
		{
			...
			effect: {
				...
				'de-de': "Wirf 2 Münzen. Dieser Angriff fügt 50 Schadenspunkte plus 20 Schadenspunkte mal der Anzahl 'Kopf' zu."
			},
			damage: "50+",
	...
	description: {
		...
		'fr-fr': "D'un coup de sa feuille éventail, il génère des bourrasques de 30 m/s capables de souffler une maison."
	},
