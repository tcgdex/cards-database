	...
	attacks: [
		{
			...
			effect: {
				...
				'de-de': "Durchsuche deinen Ablagestapel nach bis zu 5 Karten in beliebiger Kombination aus Pokémon und Unterstützungskarten. Zeige sie deinem Gegener und mische sie in dein Deck."
			},
		...
		},
		{
			...
			effect: {
				...
				'de-de': "Dieser Angriff fügt allen Pokémon auf der Bank (deinen und deines Gegners) 10 Schadenspunkte zu. (Wenn Schwäche und Resistenz bei Pokémon auf der Bank nicht an.)"
			},
			damage: 60,
