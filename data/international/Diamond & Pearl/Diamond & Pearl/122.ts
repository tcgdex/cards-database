	...
	abilities: [
		{
			...
			effect: {
				...
				'de-de': "Einmal während deines Zuges (vor deinem Angriff) wenn du mehr Preise übrig hast als dein Gegner, kannst du 1 Pokémon auf der Bank deines Gegners wählen und es gegen 1 Verteidigendes Pokémon austauschen. Diese Poke-Power kann nicht benutzt werden, wenn Chelterrar von einem Speziellen Zustand betroffen ist."
			},
		},
	],
