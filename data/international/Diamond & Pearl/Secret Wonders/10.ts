...
const card: Card = {
	...
	abilities: [
		{
			...
			name: {
				'en-us': "Phoenix Turn",
				'fr-fr': "Coup du phoenix",
				'de-de': "Phönix-Auferstehung"
			},
			effect: {
	...
	attacks: [
		{
			...
			name: {
				'en-us': "Rainbow Wing",
				'fr-fr': "Aile arc-en-ciel",
				'de-de': 'Regenbogenschwinge'
			},
			effect: {
				'en-us': "This attack does 20 damage times the number of different types of basic Energy cards attached to Ho-Oh.",
				'fr-fr': "Cette attaque inflige 20 dégâts multipliés par le nombre de types différents de cartes Énergie de base attachées à Ho-Oh.",
				'de-de': 'Dieser Angriff fügt 20 Schadenspunkte mal der Anzahl der verschiedenen Typen an Ho-Oh angelegter Basis-Energiekarten zu. '
			},
			damage: "20×",
	...
	description: {
		'en-us': "Its feathers are in seven colors. It is said that anyone seeing it is promised eternal happiness.",
	},
