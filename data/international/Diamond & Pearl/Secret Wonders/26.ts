	...
	abilities: [
		{
			...
			name: {
				'en-us': "Energy Shift",
				'fr-fr': "Déplacement d'Énergie",
				'de-de': "Energieverschiebung"
			},
			effect: {
	...
	attacks: [
		{
			...
			name: {
				'en-us': "Ion Blast",
				'fr-fr': "Explosion d'ions",
				'de-de': "Ionen-Explosion"
			},
			effect: {
				'en-us': "You may do 40 damage plus 60 more damage. If you do, Electrode does 100 damage to itself.",
				'fr-fr': "Vous pouvez infliger 40 dégâts plus 60 dégâts supplémentaires. Electrode s'inflige alors 100 dégâts.",
				'de-de': "Du kannst diesen Angriff 40 Schadenspunkte plus 60 weitere Schadenspunkte zufügen lassen. Wenn du das machst, fügt sich Lektrobal selbst 100 Schadenspunkte zu."
			},
			damage: "40+",
