	...
	abilities: [
		{
			...
			effect: {
				...
				'de-de': "Nachdem dein Gegner eine Unterstützerkarte von seiner Hand gespielt hat, lege 1 Schadensmarke auf jedes Pokémon deines Gegners. Du kannst nicht mehr als 1 Störung Poké-Body pro Zug einsetzen."
			},
		},
	],
	...
	attacks: [
		{
			...
			effect: {
				...
				'fr-fr': "Vous pouvez défausser toutes les Énergies Lightning attachées à Pharamp. Cette attaque inflige alors 20 dégâts à chacun des Pokémon de Banc de votre adversaire possédant des cartes Énergie. (Vous ne pouvez pas appliquer la Faiblesse ou la Résistance aux Pokémon de Banc).",
				'de-de': "Du kannst alle -Energien, die an Ampharos angelegt sind, auf deinen Ablagestapel legen. Wenn du das machst, fügt dieser Angriff allen Pokémon auf der Bank deines Gegners, an denen mindestens eine Energiekarte angelegt ist, 20 Schadenspunkte zu. (Wende Schwäche und Resistenz bei Pokémon auf der Bank nicht an.)"
			},
			damage: 70,
