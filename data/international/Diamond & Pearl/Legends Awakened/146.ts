	...
	attacks: [
		{
			...
			effect: {
				'en-us': "Uxie can't use Zen Blade during your next turn.",
				'fr-fr': "Créhelf ne peut pas utiliser Lame zen lors de votre prochain tour.",
				'de-de': "Selfe kann Zen-Klinge in deinem nächsten Zug nicht einsetzen."
			},
			damage: 60,
