	...
	attacks: [
		{
			...
			effect: {
				'en-us': "Discard a Fire Energy attached to Castform Sunny Form.",
				'fr-fr': "Défaussez une Énergie Fire attachée à Morpheo Soleil.",
				'de-de': "Lege 1 an Formeo Sonnenform angelegte -Energie auf deinen Ablagestapel."
			},
			damage: 40,
