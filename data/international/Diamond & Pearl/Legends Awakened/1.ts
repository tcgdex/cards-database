...
const card: Card = {
	name: {
		'en-us': "Deoxys Normal Forme",
		'fr-fr': "Deoxys Forme Normale",
		'de-de': "Deoxys Normalform"
	},
	...
	attacks: [
		{
			...
			effect: {
				'en-us': "Does 20 damage plus 10 more damage for each Energy attached to all of your opponent's Pokémon.",
				'fr-fr': "Inflige 20 dégâts plus 10 dégâts supplémentaires pour chaque Énergie attachée à tous les Pokémon de votre adversaire.",
				'de-de': "Dieser Angriff fügt 20 Schadenspunkte plus 10 weitere Schadenspunkte für jede Energie, die an allen Pokémon deines Gegners angelegt ist, zu."
			},
			damage: "20+",
