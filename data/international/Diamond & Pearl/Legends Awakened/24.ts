...
const card: Card = {
	name: {
		'en-us': "Deoxys Attack Forme",
		'fr-fr': "Deoxys Forme Attaque",
		'de-de': "Deoxys Angriffsform"
	},
	...
	attacks: [
		{
			...
			effect: {
				'en-us': "During your next turn, Deoxys's Psychic Boost attack's base damage is 20.",
				'fr-fr': "Lors de votre prochain tour, les dégâts de base de l'attaque Psycho Boost de Deoxys sont de 20.",
				'de-de': "In deinem nächsten Zug beträgt der Grundschaden von Deoxys' Angriff Psyschub 20 Schadenspunkte."
			},
			damage: 80,
