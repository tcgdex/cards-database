...
const card: Card = {
	name: {
		'en-us': "Deoxys Defense Forme",
		'fr-fr': "Deoxys Forme Défense",
		'de-de': "Deoxys Verteidigungsform"
	},
	...
	attacks: [
		{
			...
			name: {
				'en-us': "Psychic Defense",
				'fr-fr': "Défense psy",
				'de-de': "Psycho-Abwehr"
			},
			effect: {
				'en-us': "During your opponent's next turn, prevent all effects of an attack, and any damage done to Deoxys by attacks is reduced by 20 (after applying Weakness and Resistance).",
				'fr-fr': "Lors du prochain tour de votre adversaire, prévenez tous les effets d'une attaque et tous dégâts infligés à Deoxys par des attaques sont réduits de 20 (après application de la Faiblesse et de la Résistance).",
				'de-de': "Während des nächsten Zuges deines Gegners verhindere alle Effekte eines Angriffs, die Deoxys zugefügt würden, und Schaden, der Deoxys durch Angriffe zugefügt wird, wird um 20 Schadenspunkte reduziert (nachdem Schwäche und Resistenz verrechnet wurden)."
			},
			damage: 40,
