...
const card: Card = {
	...
	attacks: [
		...
		},
		{
			...
			name: {
				'en-us': "Boiling Impact",
				'fr-fr': "Impact Bouillonnant",
				'es-es': "Impacto Abrasador",
				'it-it': "Impatto Bollente",
				'pt-br': "Impacto Fervoroso",
				'de-de': "Siedeschlag"
			},
			effect: {
	...
	description: {
		'en-us': "Boiling blood, like plasma, circulates through its body. It makes its dwelling place in volcanic caves.",
	},
}
