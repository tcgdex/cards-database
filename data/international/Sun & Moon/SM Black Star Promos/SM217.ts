...
const card: Card = {
	name: {
		'en-us': "Trevenant & Dusknoir GX",
		'fr-fr': "Desséliande et Noctunoir GX",
		'es-es': "Trevenant y Dusknoir GX",
		'it-it': "Trevenant e Dusknoir GX",
		'pt-br': "Trevenant e Dusknoir GX",
		'de-de': "Trombork & Zwirrfinst GX"
	},
	...
	attacks: [
		{
			...
			name: {
				'en-us': "Night Watch",
				'fr-fr': "Veillée Nocturne",
				'es-es': "Vigilancia Nocturna",
				'it-it': "Guardia Notturna",
			...
			effect: {
				...
				'fr-fr': "Choisissez 2 cartes au hasard dans la main de votre adversaire. Votre adversaire montre ces cartes et les mélange avec son deck.",
		...
		},
		{
			...
			name: {
				'en-us': "Pale Moon GX",
				'fr-fr': "Lune Pâle GX",
				'es-es': "Luna Pálida GX",
				'it-it': "Luna Pallida GX",
				'pt-br': "Lua Pálida GX",
				'de-de': "Fahler Mond GX"
			},
			effect: {
				'en-us': "At the end of your opponent’s next turn, the Defending Pokémon will be Knocked Out. If this Pokémon has at least 1 extra Psychic Energy attached to it (in addition to this attack’s cost), discard all Energy from your opponent’s Active Pokémon. (You can’t use more than 1 GX attack in a game.)",
				'fr-fr': "À la fin du prochain tour de votre adversaire, le Pokémon Défenseur sera K.O. Si au moins une Énergie Psychic supplémentaire est attachée à ce Pokémon (en plus du coût de cette attaque), défaussez toute l’Énergie du Pokémon Actif de votre adversaire. (Vous ne pouvez utiliser qu’une attaque GX par partie.)",
				'es-es': "Al final del próximo turno de tu rival, el Pokémon Defensor quedará Fuera de Combate. Si este Pokémon tiene por lo menos 1 Energía Psychic adicional unida a él (además de las del coste de este ataque), descarta todas las Energías del Pokémon Activo de tu rival. (No puedes usar más de 1 ataque GX en una partida).",
				'it-it': "Alla fine del turno del tuo avversario, il Pokémon difensore verrà messo KO. Se questo Pokémon ha almeno un’Energia Psychic extra assegnata, in aggiunta a quelle del costo di questo attacco, scarta tutte le Energie assegnate al Pokémon attivo del tuo avversario. Non puoi usare più di un attacco GX a partita.",
				'pt-br': "O Pokémon Defensor será Nocauteado no final da próxima vez de jogar do seu oponente. Se este Pokémon tiver pelo menos 1 Energia Psychic adicional ligada a ele (além do custo deste ataque), descarte todas as Energias do Pokémon Ativo do seu oponente (você não pode usar mais de 1 ataque GX por partida).",
