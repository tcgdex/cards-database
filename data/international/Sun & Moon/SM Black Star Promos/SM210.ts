...
const card: Card = {
	name: {
		...
		'es-es': "Moltres, Zapdos y Articuno GX",
		'it-it': "Moltres, Zapdos e Articuno GX",
		'pt-br': "Moltres, Zapdos e Articuno GX",
		'de-de': "Lavados & Zapdos & Arktos GX"
	},
	...
	attacks: [
		{
			...
			name: {
				...
				'es-es': "Quemadura Trinidad",
				'it-it': "Triade Ardente",
				'pt-br': "Queimadura Tríptica",
				'de-de': "Dreiheitsbrand"
			},
		...
		},
		{
			...
			name: {
				...
				'fr-fr': "Légendes Célestes GX",
				'es-es': "Leyendas del Cielo GX",
				'it-it': "Leggende Celesti GX",
				'pt-br': "Lendas do Céu GX",
				'de-de': "Legenden der Lüfte GX"
			},
			effect: {
