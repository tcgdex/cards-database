	...
	attacks: [
		...
		},
		{
			...
			effect: {
				...
				'es-es': "Este Pokémon no puede usar Ardor Fénix durante tu próximo turno.",
				'it-it': "Durante il tuo prossimo turno, questo Pokémon non può usare Scottata della Fenice.",
				'pt-br': "Este Pokémon não poderá usar Fênix Ardente durante a sua próxima vez de jogar.",
				'de-de': "Dieses Pokémon kann Phönix-Brand während deines nächsten Zuges nicht einsetzen."
			},
			damage: 180,
		...
		},
		{
			...
			name: {
				...
				'es-es': "Llama Eterna GX",
				'it-it': "Fiamma Eterna-GX",
				'pt-br': "Flama Perene GX",
				'de-de': "Ewige Flamme GX"
			},
			effect: {
				...
				'es-es': "Pon 3 Pokémon-GX Fire o Pokémon-EX Fire, en cualquier combinación, de tu pila de descartes en tu Banca. (No puedes usar más de 1 ataque GX en una partida).",
				'it-it': "Prendi tre Pokémon-GX Fire o Pokémon-EX Fire in qualsiasi combinazione dalla tua pila degli scarti e mettili nella tua panchina. Non puoi usare più di un attacco GX a partita.",
				'pt-br': "Coloque 3 Pokémon-GX Fire ou Pokémon-EX Fire da sua pilha de descarte no seu Banco em qualquer combinação (você não pode usar mais de 1 ataque GX por partida).",
				'de-de': "Lege eine beliebige Kombination aus 3 Fire-Pokémon-GX oder Fire-Pokémon-EX aus deinem Ablagestapel auf deine Bank. (Du kannst pro Spiel nur 1 GX-Attacke einsetzen.)"
			},
