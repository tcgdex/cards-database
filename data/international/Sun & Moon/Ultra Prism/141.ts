	...
	abilities: [
		{
			...
			name: {
				...
				'es-es': "Mirada Gélida",
				'it-it': "Sguardo Glaciale",
				'pt-br': "Olhar Congelante",
				'de-de': "Gefrierblick"
			},
			effect: {
				...
				'es-es': "Mientras este Pokémon sea tu Pokémon Activo, los Pokémon-GX y Pokémon-EX de tu rival en juego, en su mano y en su pila de descartes no tienen ninguna habilidad, excepto Mirada Gélida.",
				'it-it': "Fintanto che questo Pokémon è il tuo Pokémon attivo, le abilità dei Pokémon-GX e dei Pokémon-EX in gioco, nella mano e nella pila degli scarti del tuo avversario non hanno effetto, a eccezione di Sguardo Glaciale.",
				'pt-br': "Enquanto este Pokémon for o seu Pokémon Ativo, os Pokémon-GX e Pokémon-EX em jogo, na mão e na pilha de descarte do seu oponente não têm Habilidades, exceto por Olhar Congelante.",
				'de-de': "Solang dieses Pokémon dein Aktives Pokémon ist, haben die Pokémon-GX und Pokémon-EX deines Gegners im Spiel, auf seiner Hand und in seinem Ablagestapel keine Fähigkeiten, außer Gefrierblick."
			},
		},
	],
	...
	attacks: [
		...
		},
		{
			...
			name: {
				...
				'es-es': "Lanza Polar GX",
				'it-it': "Lancia Polare-GX",
				'pt-br': "Lança Polar GX",
				'de-de': "Polarspeer GX"
			},
			effect: {
				...
				'es-es': "Este ataque hace 50 puntos de daño por cada contador de daño en el Pokémon Activo de tu rival. (No puedes usar más de 1 ataque GX en una partida).",
				'it-it': "Questo attacco infligge 50 danni per ogni segnalino danno sul Pokémon attivo del tuo avversario. Non puoi usare più di un attacco GX a partita.",
				'pt-br': "Este ataque causa 50 pontos de dano para cada contador de dano no Pokémon Ativo do seu oponente (você não pode usar mais de 1 ataque GX por partida).",
				'de-de': "Diese Attacke fügt 50 Schadenspunkte mal der Anzahl der Schadensmarken auf dem Aktiven Pokémon deines Gegners zu. (Du kannst pro Spiel nur 1 GX-Attacke einsetzen.)"
			},
			damage: "50×",
