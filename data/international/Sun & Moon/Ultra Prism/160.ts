	...
	attacks: [
		...
		},
		{
			...
			effect: {
				...
				'es-es': "Tu rival enseña las cartas de su mano. Añade, boca abajo, 1 carta que encuentres entre ellas a sus cartas de Premio. (No puedes usar más de 1 ataque GX en una partida).",
				'it-it': "Il tuo avversario mostra le carte che ha in mano. Aggiungi una carta presente tra esse alle sue carte Premio e mettila a faccia in giù. Non puoi usare più di un attacco GX a partita.",
				'pt-br': "Seu oponente revela a própria mão. Adicione, virada para baixo, 1 carta que encontrar lá às cartas de Prêmio dele(a) (você não pode usar mais de 1 ataque GX por partida).",
