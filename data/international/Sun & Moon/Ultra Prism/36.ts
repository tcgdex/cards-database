	...
	attacks: [
		...
		},
		{
			...
			name: {
				...
				'es-es': "Explosión Acuática",
				'it-it': "Esplosione Acquatica",
				'pt-br': "Explosão de Água",
				'de-de': "Wasserschuss"
			},
			effect: {
				'en-us': "Discard a Water Energy from this Pokémon.",
				'fr-fr': "Défaussez une Énergie Water de ce Pokémon.",
				'es-es': "Descarta 1 Energía Water de este Pokémon.",
				'it-it': "Scarta un’Energia Water assegnata a questo Pokémon.",
				'pt-br': "Descarte 1 Energia Water deste Pokémon.",
				'de-de': "Lege 1 Water-Energie von diesem Pokémon auf deinen Ablagestapel."
			},
			damage: 80,
