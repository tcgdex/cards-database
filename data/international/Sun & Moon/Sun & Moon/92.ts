	...
	attacks: [
		{
			...
			effect: {
				...
				'pt-br': "Se qualquer dano for causado a este Pokémon por ataques durante a próxima vez de jogar do seu oponente, jogue 1 moeda. Se sair cara, previna esse dano.",
				'de-de': "Wirf 1 Münze, wenn diesem Pokémon während des nächsten Zuges deines Gegners durch Attacken Schaden zugefügt wird. Verhindere diesen Schaden bei Kopf."
			},
			damage: 10,
