...
const card: Card = {
	name: {
		'en-us': "Custom Catcher",
		'fr-fr': "Attrape-Perso",
		'es-es': "Capturador Personalizado",
		'it-it': "Acchiappa-Pokémon Modificato",
		'pt-br': "Pegador Personalizado",
		'de-de': "Flexfänger"
	},
