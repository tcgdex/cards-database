	...
	abilities: [
		{
			type: "Ability",
			name: {
				'en-us': "Mysterious Guidance",
				'fr-fr': "Guide Mystérieux",
				'es-es': "Guía Misteriosa",
				'it-it': "Guida Segreta",
				'pt-br': "Orientação Misteriosa",
				'de-de': "Geheimnisvolle Hilfe"
			},
			effect: {
				'en-us': "When you play this Pokémon from your hand to evolve 1 of your Pokémon during your turn, you may search your deck for up to 2 Item cards, reveal them, and put them into your hand. Then, shuffle your deck.",
				'fr-fr': "Lorsque vous jouez ce Pokémon de votre main pour faire évoluer l’un de vos Pokémon pendant votre tour, vous pouvez chercher jusqu’à 2 cartes Objet dans votre deck, les montrer et les ajouter à votre main. Mélangez ensuite votre deck.",
				'es-es': "Cuando juegues este Pokémon de tu mano para hacer evolucionar a 1 de tus Pokémon durante tu turno, puedes buscar en tu baraja hasta 2 cartas de Objeto, enseñarlas y ponerlas en tu mano. Después, baraja las cartas de tu baraja.",
				'it-it': "Quando giochi questo Pokémon dalla tua mano per far evolvere uno dei tuoi Pokémon durante il tuo turno, puoi cercare nel tuo mazzo fino a due carte Strumento, mostrarle e aggiungerle a quelle che hai in mano. Poi rimischia le carte del tuo mazzo.",
				'pt-br': "Quando você joga este Pokémon da sua mão para evoluir 1 dos seus Pokémon durante a sua vez de jogar, você pode procurar por até 2 cartas de Item no seu baralho, revelá-las e colocá-las na sua mão. Em seguida, embaralhe o seu baralho.",
				'de-de': "Wenn du dieses Pokémon aus deiner Hand spielst, um 1 deiner Pokémon während deines Zuges zu entwickeln, kannst du dein Deck nach bis zu 2 Itemkarten durchsuchen, sie deinem Gegner zeigen und sie auf deine Hand nehmen. Mische anschließend dein Deck."
			},
		},
	],
	...
	attacks: [
		{
			...
			name: {
				...
				'es-es': "Viento Níveo",
				'it-it': "Vento Nevoso",
				'pt-br': "Ventania Nevada",
				'de-de': "Schnee und Wind"
			},
			effect: {
		...
		},
		{
			...
			name: {
				'en-us': "Sublimation GX",
				'fr-fr': "Sublimation GX",
				'es-es': "Sublimación GX",
				'it-it': "Sublimazione-GX",
				'pt-br': "Sublimação GX",
				'de-de': "Sublimation GX"
			},
			effect: {
