...
const card: Card = {
	name: {
		'en-us': "Mixed Herbs",
		'fr-fr': "Mélange d’Herbes",
		'es-es': "Hierbas Combinadas",
		'it-it': "Infuso di Erbe",
		'pt-br': "Mistura de Ervas",
		'de-de': "Kräutermischung"
	},
