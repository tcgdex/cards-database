...
const card: Card = {
	name: {
		'en-us': "Arceus & Dialga & Palkia GX",
		'fr-fr': "Arceus, Dialga et Palkia GX",
		'es-es': "Arceus, Dialga y Palkia GX",
		'it-it': "Arceus, Dialga e Palkia GX",
		'pt-br': "Arceus, Dialga e Palkia GX",
		'de-de': "Arceus & Dialga & Palkia GX"
	},
	...
	attacks: [
		{
			...
			name: {
				'en-us': "Ultimate Ray",
				'fr-fr': "Rayon Ultime",
				'es-es': "Rayo Definitivo",
				'it-it': "Raggio Finale",
				'pt-br': "Raio Supremo",
				'de-de': "Vollendeter Strahl"
			},
			effect: {
		...
		},
		{
			...
			name: {
				'en-us': "Altered Creation GX",
				'fr-fr': "Création Altérée GX",
				'es-es': "Creación Alterada GX",
				'it-it': "Creazione Alterata GX",
				'pt-br': "Origem Alternativa GX",
				'de-de': "Veränderte Kreation GX"
			},
			effect: {
				'en-us': "For the rest of this game, your Pokémon’s attacks do 30 more damage to your opponent’s Active Pokémon (before applying Weakness and Resistance). If this Pokémon has at least 1 extra Water Energy attached to it (in addition to this attack’s cost), when your opponent’s Active Pokémon is Knocked Out by damage from those attacks, take 1 more Prize card. (You can’t use more than 1 GX attack in a game.)",
