	...
	attacks: [
		...
		},
		{
			...
			effect: {
				...
				'fr-fr': "Pendant le prochain tour de votre adversaire, évitez tous les dégâts infligés à ce Pokémon par des attaques dont le montant des dégâts est de 40 ou moins.",
				'es-es': "Durante el próximo turno de tu rival, evita todo el daño infligido a este Pokémon por ataques si el daño es de 40 puntos o menos.",
				...
				'pt-br': "Durante a próxima vez de jogar do seu oponente, prevenirá todo dano causado a este Pokémon por ataques se aquele dano for 40 ou menos.",
