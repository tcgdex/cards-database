...
const card: Card = {
	...
	attacks: [
		...
		},
		{
			...
			name: {
				'en-us': "Beat Slider",
				'fr-fr': "Frappe Glissante",
				'es-es': "Toque Deslizante",
				'it-it': "Botta Scivolosa",
				'pt-br': "Batida Deslizante",
				'de-de': "Schieberegler"
			},
			effect: {
	...
	description: {
		'en-us': "An amazingly friendly Pokémon, but if left to itself, loneliness overcomes it, and it oozes gooey tears.",
	},
