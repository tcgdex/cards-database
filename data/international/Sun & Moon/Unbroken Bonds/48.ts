...
const card: Card = {
	...
	description: {
		'en-us': "Although known for their splendid tail fins, Goldeen apparently compete among themselves to see whose horn is thickest and sharpest.",
	},
