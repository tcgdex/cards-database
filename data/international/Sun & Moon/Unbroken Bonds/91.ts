...
const card: Card = {
	...
	attacks: [
		{
			...
			effect: {
				...
				'fr-fr': "Lancez une pièce jusqu’à ce que vous obteniez un côté pile. Cette attaque inflige 50 dégâts pour chaque côté face.",
				...
				'pt-br': "Jogue 1 moeda até sair coroa. Este ataque causa 50 pontos de dano para cada cara.",
				'de-de': "Wirf so lang 1 Münze, bis zum ersten Mal das Ergebnis Zahl kommt. Diese Attacke fügt 50 Schadenspunkte pro Kopf zu."
			},
			damage: "50×",
		...
		},
		{
			...
			effect: {
				...
				'pt-br': "Se o Pokémon Ativo do seu oponente tiver alguma carta de Ferramenta Pokémon ligada a ele, este ataque causará 70 pontos de dano a mais.",
				'de-de': "Wenn an das Aktive Pokémon deines Gegners eine Pokémon-Ausrüstung angelegt ist, fügt diese Attacke 70 Schadenspunkte mehr zu."
			},
			damage: "70+",
	...
	description: {
		'en-us': "It throws bones at Mandibuzz to knock it down. It's thought that Marowak is trying to avenge its parent.",
	},
