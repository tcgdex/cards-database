...
const card: Card = {
	...
	abilities: [
		{
			...
			effect: {
				...
				'es-es': "Cuando juegues este Pokémon de tu mano para hacer evolucionar a 1 de tus Pokémon durante tu turno, puedes evitar todos los efectos de los ataques de tu rival, incluido el daño, infligidos a este Pokémon hasta el final del próximo turno de tu rival.",
				...
				'pt-br': "Quando você joga este Pokémon da sua mão para evoluir 1 dos seus Pokémon durante a sua vez de jogar, você pode prevenir todos os efeitos dos ataques do seu oponente, incluindo dano, causados a este Pokémon até o final da próxima vez de jogar do seu oponente.",
	...
	description: {
		'en-us': "Its fangs are so sharp, if it bites you in the dark and sucks your blood, you won't notice any pain or realize you've been bitten.",
	},
