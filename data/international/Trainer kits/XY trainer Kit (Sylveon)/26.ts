...
const card: Card = {
	...
	effect: {
		...
		'es-es': "Lanza 1 moneda. Si sale cara, busca en tu baraja 1 Pokémon, enséñalo y ponlo en tu mano. Baraja las cartas de tu baraja después.",
		...
		'pt-br': "Jogue uma moeda. Se sair cara, procure um Pokémon no seu baralho, mostre-o e coloque-o em sua mão. Em seguida, embaralhe seus cards.",
