	...
	attacks: [
		...
		},
		{
			...
			effect: {
				...
				'fr-fr': "Tous les dégâts infligés à Kapoera par des attaques durant le prochain tour de votre adversaire sont augmentés de 20 (après application de la Faiblesse et de la Résistance).",
