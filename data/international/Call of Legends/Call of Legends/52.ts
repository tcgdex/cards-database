	...
	attacks: [
		...
		},
		{
			...
			effect: {
				...
				'fr-fr': "Choisissez 2 Pokémon de votre adversaire. Cette attaque inflige 30 dégâts à chacun d'entre eux. (N'appliquez pas la Faiblesse et la Résistance aux Pokémon de Banc.)",
