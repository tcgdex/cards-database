...
const card: Card = {
	name: {
		'en-us': "Charon's Choice",
		'fr-fr': "Le choix de Pluton",
		'de-de': "Charons Wahl"
	},
	...
	effect: {
		...
		'fr-fr': "Vous ne pouvez jouer qu'une seule carte Supporter par tour. Lorsque vous la jouez, placez-la à côté de votre Pokémon Actif. Lorsque votre tour est terminé, placez cette carte dans votre main au lieu de la défausser.",
