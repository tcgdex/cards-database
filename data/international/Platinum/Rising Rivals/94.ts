...
const card: Card = {
	name: {
		'en-us': "Sunyshore City Gym",
		'fr-fr': "Le gymnase de Rivamar City",
		'de-de': "Sonnewik-Arena"
	},
	...
	effect: {
		...
		'de-de': "Schaden, der den Verteidigenden Pokémon durch -Pokémon (deinen und denen deines Gegners) zugefügt wird, wird durch Resistenz nicht verändert. Alle -Pokémon im Spiel (deine und die deines Gegners) haben keine Schwäche."
	},
