	...
	abilities: [
		{
			...
			effect: {
				...
				de: "Beliebig oft während deines Zuges (vor deinem Angriff) kannst du 1 {L}-Energie, die an 1 deiner Pokémon angelegt ist, an Raichu anlegen. Diese Poké-Power kann nicht benutzt werden, wenn Raichu von einem Speziellen Zustand betroffen ist."
			}
		},
	],
