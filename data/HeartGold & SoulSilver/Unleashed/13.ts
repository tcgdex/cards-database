...
const card: Card = {
	...
	abilities: [
		{
			...
			effect: {
				...
				de: "Beliebig oft während deines Zuges (vor deinem Angriff) kannst du 1 {W}-Energie, die an 1 Pokémon auf deiner Bank angelegt ist, an dein Aktives Pokémon anlegen. Diese Poké-Power kann nicht benutzt werden, wenn Turtok von einem Speziellen Zustand betroffen ist."
			}
		},
	],
	...
	attacks: [
		{
			...
			effect: {
				...
				de: "Nimm 2 {W}-Energie, die an Turtok angelegt sind, zurück auf deine Hand und wähle dann 1 Pokémon deines Gegners. Dieser Angriff fügt dem ausgewählten Pokémon 100 Schadenspunkte zu. (Wende Schwäche und Resistenz bei Pokémon auf der Bank nicht an.)"
			},
	...
	description: {
		...
		de: "Es macht sich absichtlich schwer, um den Rückstoß seiner Hydropumpe abzufangen."
	},
