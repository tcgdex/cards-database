...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			'en-us': "Put 1 random Weedle from your deck onto your Bench.",
			'fr-fr': "Placez une carte Aspicot au hasard de votre deck sur votre Banc.",
			'es-es': "Pon 1 Weedle aleatorio de tu baraja en tu Banca.",
			'it-it': "Prendi un Weedle a caso dal tuo mazzo e mettilo nella tua panchina.",
			'de-de': "Lege 1 zufälliges Hornliu aus deinem Deck auf deine Bank.",
			'pt-br': "Coloque 1 Weedle aleatório do seu baralho no seu Banco.",
			'ko-kr': "자신의 덱에서 「뿔충이」를 랜덤으로 1장 벤치로 내보낸다."
		}
	}],
