...
const card: Card = {
	...
	description: {
		...
		'fr-fr': "Son souffle brûlant peut faire fondre la roche.\nIl est parfois la cause d'incendies de forêt.",
		'es-es': "Escupe un fuego tan caliente que funde las\nrocas. Causa incendios forestales sin querer.",
		'it-it': "Sputa fiamme incandescenti in grado di fondere\nle rocce. A volte causa incendi boschivi.",
		'de-de': "Dieses Pokémon kann mit seinem\nFeueratem Felsen schmelzen.\nEs verursacht ab und zu Waldbrände.",
