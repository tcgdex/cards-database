...
const card: Card = {
	...
	description: {
		'en-us': "The drier the area Sandslash lives in, the harder and smoother the Pokémon's spikes will feel when touched.",
		'fr-fr': "Plus son habitat est sec, plus ses épines\ndorsales deviennent dures et lisses.",
		'es-es': "Cuanto más seco es el terreno en el\nque habita, más duras y lisas se vuelven\nlas púas que le recubren la espalda.",
		'it-it': "Più secco è il territorio dove Sandslash vive,\npiù i suoi aculei dorsali diventano lisci e duri.",
		'de-de': "Je trockener das Gebiet ist, in dem Sandamer\nlebt, desto härter und glatter fühlen sich die\nStacheln an seinem Rücken an.",
