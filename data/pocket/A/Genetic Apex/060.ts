...
const card: Card = {
	...
	description: {
		'en-us': "Staring at the swirl on its belly causes drowsiness. This trait of Poliwhirl's has been used in place of lullabies to get children to go to sleep.",
		'fr-fr': "Il suffit de fixer la spirale sur son ventre pour\ns'assoupir. On se sert parfois de lui à la place\nd'une berceuse pour endormir les enfants.",
		'es-es': "Mirar fijamente la espiral de su vientre provoca\nsomnolencia, por lo que puede usarse como\nalternativa a las nanas para dormir a los niños.",
		'it-it': "Chi fissa a lungo il disegno spiraliforme sul ventre\nsi assopisce, tant'è che Poliwhirl lo utilizza al\nposto della ninnananna per far dormire i piccoli.",
		'de-de': "Wer länger auf seine Bauchspirale blickt, wird\nschläfrig. Manche Leute nutzen dies anstelle\neines Schlaflieds, damit ihre Kinder einschlafen.",
