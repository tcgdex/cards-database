...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			...
			'es-es': "Lanza 1 moneda. Si sale cara, este ataque hace 40 puntos de daño más. Si sale cruz, este Pokémon también se hace 20 puntos de daño a sí mismo.",
			'it-it': "Lancia una moneta. Se esce testa, questo attacco infligge 40 danni in più. Se esce croce, questo Pokémon infligge anche 20 danni a se stesso.",
			'de-de': "Wirf 1 Münze. Bei Kopf fügt diese Attacke 40 Schadenspunkte mehr zu. Bei Zahl fügt dieses Pokémon auch sich selbst 20 Schadenspunkte zu.",
			...
			'ko-kr': "동전을 1번 던져서 앞면이 나오면 40데미지를 추가한다. 뒷면이 나오면 이 포켓몬에게도 20데미지를 준다."
		},
