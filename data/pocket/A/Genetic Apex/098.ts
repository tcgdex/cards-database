...
const card: Card = {
	...
	abilities: [{
		...
		effect: {
			...
			'es-es': "Una vez durante tu turno, puedes unir 1 Energía {L} de tu área de Energía a este Pokémon.",
			'it-it': "Una sola volta durante il tuo turno, puoi prendere un'Energia {L} dalla tua Zona Energia e assegnarla a questo Pokémon.",
			'de-de': "Einmal während deines Zuges kannst du 1 {L}-Energie aus deinem Energiebereich an dieses Pokémon anlegen.",
			'ko-kr': "자신의 차례에 1번 사용할 수 있다. 자신의 에너지존에서 {L}에너지를 1개 내보내 이 포켓몬에게 붙인다.",
