...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			...
			'it-it': "Lancia 2 volte una moneta. Questo attacco infligge 100 danni ogni volta che esce testa.",
			...
			'ko-kr': "동전을 2번 던져서 앞면이 나온 수 × 100데미지를 준다."
		},
