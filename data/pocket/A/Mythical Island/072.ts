...
const card: Card = {
	...
	abilities: [{
		...
		effect: {
			'en-us': "As often as you like during your turn, you may move a {W} Energy from 1 of your Benched {W} Pokémon to your Active {W} Pokémon.",
			'fr-fr': "Autant de fois que vous le voulez pendant votre tour, vous pouvez déplacer une Énergie {W} de l'un de vos Pokémon {W} de Banc vers votre Pokémon {W} Actif.",
			'es-es': "Todas las veces que quieras durante tu turno, puedes mover 1 Energía {W} de 1 de tus Pokémon {W} en Banca a tu Pokémon {W} Activo.",
			'it-it': "Durante il tuo turno, puoi spostare un'Energia {W} da uno dei tuoi Pokémon {W} in panchina al tuo Pokémon {W} in posizione attiva tutte le volte che vuoi.",
			'de-de': "Beliebig oft während deines Zuges kannst du 1 {W}-Energie von 1 {W}-Pokémon auf deiner Bank auf dein Aktives {W}-Pokémon verschieben.",
			...
			'ko-kr': "자신의 차례에 몇 번이라도 사용할 수 있다. 자신의 벤치의 {W}포켓몬에서 {W}에너지를 1개 배틀필드의 {W}포켓몬에게 바꿔 붙인다."
		}
	}],
