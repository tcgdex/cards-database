...
const card: Card = {
	...
	description: {
		'en-us': "Druddigon lives in caves, but it never skips sunbathing—it won't be able to move if its body gets too cold.",
		'fr-fr': "Il vit sous terre, mais il doit impérativement\ns'exposer au soleil, car il devient incapable\nde bouger lorsque son corps se refroidit.",
		'es-es': "Habita en túneles. Pierde la movilidad si baja su\ntemperatura corporal, por lo que aprovecha la\nmenor oportunidad para tomar el sol.",
		'it-it': "Vive in cavità sotterranee, ma poiché non\nriesce più a muoversi se il suo corpo si\nraffredda, non può fare a meno dei bagni di sole.",
		'de-de': "Shardrago lebt in Grotten. Kühlt sein Körper ab,\nerstarrt es, weshalb es regelmäßig Sonnenbäder\nnehmen muss.",
