...
const card: Card = {
	...
	name: {
		...
		'fr-fr': "Triopikeurd'Alola",
		'es-es': "Dugtriode Alola",
		'it-it': "Dugtriodi Alola",
		'de-de': "Alola-Digdri",
	...
	description: {
		'en-us': "Their beautiful, metallic whiskers create a sort of protective helmet on their heads, and they also function as highly precise sensors.",
		'fr-fr': "Les magnifiques vibrisses métalliques\nsur ses têtes lui servent à la fois de casque\nprotecteur et de détecteur très précis.",
		'es-es': "Las espléndidas melenas metálicas que cubren sus cabezas hacen\nlas veces de casco protector y de sensor de gran precisión.",
		'it-it': "Oltre a proteggerlo come un casco, le sue meravigliose\nchiome metalliche fungono da sensori estremamente precisi.",
		'de-de': "Seine prächtigen, metallischen Haare schützen seine\nKöpfe wie ein Helm. Gleichzeitig dienen sie ihm als\npräzise Sensoren.",
	...
	attacks: [{
		...
		effect: {
			...
			'ko-kr': "뒷면이 나올 때까지 동전을 던져서 앞면이 나온 수 × 70데미지를 준다."
		}
	}],
