...
const card: Card = {
	...
	description: {
		'en-us': "Concrete mixed by Conkeldurr is much more durable than normal concrete, even when the compositions of the two materials are the same.",
		'fr-fr': "Le béton préparé par Bétochef est bien\nplus solide qu'un béton ordinaire, même\nsi les mêmes ingrédients sont utilisés.",
		'es-es': "El hormigón que preparan los Conkeldurr es mucho más duro y\nresistente que el ordinario, aunque la composición sea la misma.",
		'it-it': "Il cemento preparato da Conkeldurr è molto più duro e resistente\ndella media, anche se la sua composizione non ha nulla di diverso.",
		'de-de': "Beton, der von Meistagrif angerührt wurde,\nist härter und robuster als jeder andere Beton,\nselbst wenn die Inhaltsstoffe identisch sind.",
	...
	abilities: [{
		...
		effect: {
			...
			'ko-kr': "이 포켓몬이 기술의 데미지를 받아 기절할 때 자신은 동전을 1번 던진다. 앞면이 나오면 이 포켓몬은 기절하지 않고 남은 HP가 10인 상태로 필드에 남는다."
		}
	}],
