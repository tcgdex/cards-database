...
const card: Card = {
	...
	description: {
		...
		'fr-fr': "Ce Pokémon se protège avec la carapace\ndérobée à un Escargaume et attaque\navec ses deux redoutables lances.",
		'es-es': "Se defienden de los ataques con el caparazón que roban\na los Shelmet. Atacan con sus dos mortíferas lanzas.",
		'it-it': "Protegge il corpo con la conchiglia che ha rubato a\nShelmet mentre spunzona il nemico con due lance.",
		'de-de': "Eine von einem Schnuthelm gestohlene Muschel\ndient ihm als Helm. Es greift Gegner mit seinen\nbeiden Lanzen an.",
