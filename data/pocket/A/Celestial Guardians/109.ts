...
const card: Card = {
	...
	name: {
		...
		'fr-fr': "Persiand'Alola",
		'es-es': "Persiande Alola",
		'it-it': "Persiandi Alola",
	...
	description: {
		'en-us': "The round face of Alolan Persian is considered to be a symbol of prosperity in the Alola region, so these Pokémon are very well cared for.",
		'fr-fr': "À Alola, sa tête ronde est considérée comme\nun symbole de prospérité, aussi ce Pokémon\nest-il traité avec le plus grand respect.",
		'es-es': "En Alola todos consideran la cara redonda\nde los Persian un símbolo de buena fortuna,\npor lo que los tratan con mucho respeto.",
		'it-it': "Nella regione di Alola le facce tonde sono considerate un simbolo\ndi prosperità e per questo Persian è trattato con molto riguardo.",
		'de-de': "Da runde Gesichter in der Alola-Region als Symbol\nfür Wohlstand gelten, zollt man diesem Pokémon\ndort großen Respekt.",
