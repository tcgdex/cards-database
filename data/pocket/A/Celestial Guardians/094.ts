...
const card: Card = {
	...
	description: {
		'en-us': "It loves helping out with construction projects. It loves it so much that if rain causes work to halt, it swings its log around and throws a tantrum.",
		'fr-fr': "Il aime donner un coup de main sur les chantiers.\nLorsque le travail cesse à cause de la pluie,\nil brandit sa poutre de colère.",
		'es-es': "Le gusta ayudar en labores de construcción.\nCuando la lluvia obliga a interrumpir las\nobras, blande con furia su viga de madera.",
		'it-it': "Gli piace dare una mano nei lavori edili, e quando vengono\ninterrotti per la pioggia, si sfoga facendo roteare la sua trave.",
		'de-de': "Es hilft gern auf Baustellen aus. Bleiben diese bei Regen\ngeschlossen, macht es seinem Ärger Luft, indem es\nseinen Holzbalken schwingt.",
