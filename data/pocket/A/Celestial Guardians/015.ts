...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			...
			'es-es': "Este ataque hace 20 puntos de daño a cada uno de los Pokémon de tu rival.",
			'it-it': "Questo attacco infligge 20 danni a ciascuno dei Pokémon del tuo avversario.",
			'de-de': "Diese Attacke fügt jedem Pokémon deines Gegners 20 Schadenspunkte zu.",
			'pt-br': "Este ataque causa 20 pontos de dano a cada um dos Pokémon do seu oponente.",
			'ko-kr': "상대의 포켓몬 전원에게 20데미지를 준다."
		}
	}],
