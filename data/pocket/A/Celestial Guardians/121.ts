...
const card: Card = {
	...
	description: {
		'en-us': "Once it absorbs a key's metal ions, it discards the key without a second thought. However, it will hang on to keys it favors for decades.",
		'fr-fr': "Dès qu'il a absorbé les ions métalliques d'une clé,\nil s'en débarrasse. Néanmoins, s'il en trouve une\nqui lui plaît, il la gardera pendant des années.",
		'es-es': "No duda en deshacerse de las llaves una vez\nabsorbidos sus iones metálicos, aunque, si una\nle gusta de verdad, la atesorará durante décadas.",
		'it-it': "Quando ha finito di assorbire gli ioni metallici\nda una chiave la getta via subito, ma se una\ngli va davvero a genio la conserva per decenni.",
		'de-de': "Sobald es die Metall-Ionen eines Schlüssels eingesaugt hat,\nwirft es ihn einfach weg. Seine Lieblingsschlüssel behält es\njedoch viele Jahre.",
