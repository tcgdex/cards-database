...
const card: Card = {
	...
	description: {
		'en-us': "They normally inhabit rocky seashores, but in times of continuous rain, they can sometimes be found in the mountains, far from the sea.",
		'fr-fr': "On le rencontre généralement sur les côtes, mais\nquand il pleut suffisamment longtemps, on peut\nl'apercevoir dans les montagnes, loin de la mer.",
		'es-es': "Normalmente viven en la costa, pero también\nes posible encontrarlos en montañas alejadas\ndel mar cuando caen lluvias persistentes.",
		'it-it': "Di solito vive sui litorali rocciosi, ma in periodi\ndi piogge durature può capitare di trovarlo\nanche su monti molto distanti dal mare.",
		'de-de': "Normalerweise hält es sich an der Küste auf,\ndoch bei fortdauerndem Regen trifft man es\nauch fernab vom Meer in den Bergen an.",
