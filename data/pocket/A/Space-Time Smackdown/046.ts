...
const card: Card = {
	...
	description: {
		'en-us': "It can control its body temperature at will. This enables it to freeze the moisture in the atmosphere, creating flurries of diamond dust.",
		'fr-fr': "Il peut contrôler la température de son corps à volonté\net créer des cristaux de glace en gelant l'humidité de l'air.",
		'es-es': "Controla a su antojo la temperatura corporal\ny congela las partículas de agua que flotan en\nel aire para provocar ráfagas de nieve en polvo.",
		'it-it': "Può modificare a piacimento la sua temperatura\ncorporea. Così può congelare l'umidità dell'aria\ne creare cristalli di ghiaccio intorno a sé.",
		'de-de': "Es kann seine Körpertemperatur frei regulieren.\nIndem es die Wasserbestandteile der Luft\ngefrieren lässt, wirbelt es Diamantstaub auf.",
