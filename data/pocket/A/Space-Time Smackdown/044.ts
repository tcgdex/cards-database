...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			...
			'ko-kr': "상대의 배틀 포켓몬이 {F}포켓몬이라면 30데미지를 추가한다."
		}
	}],
