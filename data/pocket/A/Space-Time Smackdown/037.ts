...
const card: Card = {
	...
	description: {
		...
		'fr-fr': "Il nage aussi vite qu'un hors-bord. Le tranchant de\nses ailes peut fendre un bloc de glace à la dérive.",
		'es-es': "Nada tan rápido como un fueraborda. Con los\nafilados bordes de sus alas puede cortar el hielo.",
		'it-it': "Nuota veloce come una moto d'acqua. Le estremità\ndelle ali sono aguzze e spaccano anche il ghiaccio.",
		'de-de': "Es schwimmt so schnell wie ein Rennboot. Seine Flügel\nhaben scharfe Seiten und können Packeis schneiden.",
