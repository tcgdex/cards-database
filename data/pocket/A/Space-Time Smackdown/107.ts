...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			'en-us': "Flip a coin for each Pokémon you have in play. This attack does 20 damage for each heads.",
			...
			'es-es': "Lanza 1 moneda por cada Pokémon que tengas en juego. Este ataque hace 20 puntos de daño por cada cara.",
			'it-it': "Lancia una moneta per ogni Pokémon che hai in gioco. Questo attacco infligge 20 danni ogni volta che esce testa.",
			'de-de': "Wirf 1 Münze für jedes Pokémon, das du im Spiel hast. Diese Attacke fügt 20 Schadenspunkte pro Kopf zu.",
			'pt-br': "Jogue 1 moeda para cada Pokémon que você tem em jogo. Este ataque causa 20 pontos de dano para cada cara.",
			'ko-kr': "자신의 필드의 포켓몬의 수만큼 동전을 던져서 앞면이 나온 수 20× 20데미지를[/Ctrl:NoBreak] 준다."
		}
	}],
