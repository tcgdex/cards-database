...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			...
			'it-it': "Prendi un'Energia {L} dalla tua Zona Energia e assegnala a questo Pokémon.",
			'de-de': "Lege 1 {L}-Energie aus deinem Energiebereich an dieses Pokémon an.",
			'pt-br': "Pegue 1 Energia {L} da sua Zona de Energia e ligue-a a este Pokémon.",
			'ko-kr': "자신의 에너지존에서 {L}에너지를 1개 내보내 이 포켓몬에게 붙인다."
		}
	}],
