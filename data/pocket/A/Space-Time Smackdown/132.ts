...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			...
			'it-it': "Prima di infliggere danni, scarta tutti gli Oggetti Pokémon dal Pokémon attivo del tuo avversario.",
			'de-de': "Bevor du Schaden zufügst, lege alle Pokémon-Ausrüstungen vom Aktiven Pokémon deines Gegners ab.",
			'pt-br': "Antes de causar dano, descarte todas as Ferramentas Pokémon do Pokémon Ativo do seu oponente.",
			'ko-kr': "데미지를 주기 전에 상대의 배틀 포켓몬으로부터 「포켓몬의 도구」를 트래쉬한다."
		}
	}],
