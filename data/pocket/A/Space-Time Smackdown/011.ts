...
const card: Card = {
	...
	description: {
		...
		'fr-fr': "Il vit en forêt près de l'eau. En journée, il la\nquitte pour dorer sa carapace feuillue au soleil.",
		'es-es': "Vive en los bosques cerca del agua. Por el día,\nsale a que les dé el sol a las plantas de su espalda.",
		'it-it': "Vive nelle foreste vicino all'acqua, ma esce di\ngiorno per far prendere sole alle piante sul guscio.",
		'de-de': "Es lebt in der Nähe von Wasser in Wäldern.\nTagsüber verlässt es diese, um ein Sonnenbad\nzu nehmen.",
