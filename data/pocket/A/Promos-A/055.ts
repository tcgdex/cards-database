...
const card: Card = {
	...
	description: {
		'en-us': "It quickly swings its four arms to rock its\nopponents with ceaseless punches and chops\nfrom all angles.",
	...
	attacks: [{
		...
		effect: {
			'en-us': "If this Pokémon has at least 2 extra {F} Energy attached, this attack does 50 more damage.",
			'fr-fr': "Si ce Pokémon a au moins 2 Énergies {F} de plus, cette attaque inflige 50 dégâts supplémentaires.",
			'es-es': "Si este Pokémon tiene por lo menos 2 Energías {F} adicionales unidas a él, este ataque hace 50 puntos de daño más.",
			'it-it': "Se questo Pokémon ha almeno 2 Energie {F} extra assegnate, questo attacco infligge 50 danni in più.",
			'de-de': "Wenn an dieses Pokémon mindestens 2 extra {F}-Energien angelegt sind, fügt diese Attacke 50 Schadenspunkte mehr zu.",
			'pt-br': "Se este Pokémon tiver pelo menos 2 Energia {F} extra ligada a ele, este ataque causará 50 pontos de dano a mais.",
			'ko-kr': "{F}에너지 2개가 추가로 붙어 있다면 50데미지를 추가한다."
		}
	}],
