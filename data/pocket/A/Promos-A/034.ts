...
const card: Card = {
	...
	description: {
		'en-us': "It doesn't like to be taken care of. It's difficult to\nbond with since it won't listen to its Trainer.",
		'fr-fr': "Ce Pokémon est difficile à entraîner car il est très\ndésobéissant et déteste qu'on lui rende service.",
		'es-es': "No le gusta que lo cuiden. Como no aprecia el apoyo\nde su Entrenador, le cuesta coger confianza con él.",
		'it-it': "Molto orgoglioso. Difficile farci amicizia\nperché non ascolta mai i consigli dell'Allenatore.",
		'de-de': "Einmischung kann es gar nicht leiden. Es ist bockig\nund fasst nur schwer Zutrauen zu seinem Trainer.",
