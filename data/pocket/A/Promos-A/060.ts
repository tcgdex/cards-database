...
const card: Card = {
	...
	attacks: [{
		name: {
			'en-us': "Growth Spurt",
			'fr-fr': "Jaillissement",
			'es-es': "Crecimiento Repentino",
			'it-it': "Crescita Inaspettata",
		...
		cost: ["Colorless"],
		effect: {
			'en-us': "Take a {G} Energy from your Energy Zone and attach it to this Pokémon.",
			'fr-fr': "Prenez une Énergie {G} de votre zone Énergie et attachez-la à ce Pokémon.",
			'es-es': "Une 1 Energía {G} de tu área de Energía a este Pokémon.",
			'it-it': "Prendi un'Energia {G} dalla tua Zona Energia e assegnala a questo Pokémon.",
			'de-de': "Lege 1 {G}-Energie aus deinem Energiebereich an dieses Pokémon an.",
			'ko-kr': "자신의 에너지존에서 {G}에너지를 1개 내보내 이 포켓몬에게 붙인다.",
