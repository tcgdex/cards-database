...
const card: Card = {
	...
	name: {
		...
		'fr-fr': "DialgaForme Originelle",
		'es-es': "DialgaOrigen",
		'it-it': "DialgaForma Originale",
		'de-de': "Ur-Dialga",
	...
	attacks: [{
		name: {
			'en-us': "Time Mash",
			'fr-fr': "Compression Temporelle",
			'es-es': "Espacio Ácrono",
			'it-it': "Botta Temporale",
			'de-de': "Zeitenbrecher",
		...
		effect: {
			...
			'ko-kr': "동전을 1번 던져서 뒷면이 나오면 자신의 다음 차례에 이 포켓몬은 기술을 사용할 수 없다."
		}
	}],
