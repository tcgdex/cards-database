...
const card: Card = {
	...
	description: {
		'en-us': "As a bud, it barely moves. It sits still, placidly waiting for sunlight to appear.",
		'fr-fr': "Pendant sa période de bourgeonnement, il reste\npresque totalement immobile et attend que le soleil se lève.",
		'es-es': "Permanece casi inmóvil cerrado en un capullo\na la espera de que lo bañen los rayos del sol.",
		'it-it': "Quando è un bocciolo rimane pressoché\nimmobile in attesa che spunti il sole.",
		'de-de': "Als Knospe verhält es sich ruhig und bewegt sich kaum,\nwährend es geduldig auf Sonnenschein wartet.",
