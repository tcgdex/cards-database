...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			'en-us': "Your opponent's Active Pokémon is now Poisoned. Do 20 damage to this Pokémon instead of the usual amount for this Special Condition.",
			'fr-fr': "Le Pokémon Actif de votre adversaire est maintenant Empoisonné. Infligez 20 dégâts à ce Pokémon au lieu de la quantité habituelle pour cet État Spécial.",
			'es-es': "El Pokémon Activo de tu rival pasa a estar Envenenado. Ese Pokémon sufre 20 puntos de daño en vez de la cantidad habitual por esta Condición Especial.",
			'it-it': "Il Pokémon attivo del tuo avversario viene avvelenato. Infliggi 20 danni a quel Pokémon invece della quantità normalmente prevista per questa condizione speciale.",
			'de-de': "Das Aktive Pokémon deines Gegners ist jetzt vergiftet. Füge dem Pokémon 20 Schadenspunkte zu anstelle der für diesen Speziellen Zustand üblichen Menge an Schadenspunkten.",
			
			'ko-kr': "상대의 배틀 포켓몬을 독으로 만든다. 이 독의 데미지는 20이 된다.",
