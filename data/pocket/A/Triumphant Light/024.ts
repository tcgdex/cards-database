...
const card: Card = {
	...
	description: {
		...
		'fr-fr': "Il gonfle la bouée de sa tête et se laisse flotter\nà la surface quand la mer se réchauffe.",
		'es-es': "Si sube la temperatura del mar, infla el flotador\nde su cabeza y flota en grupo en la superficie.",
		'it-it': "Quando la temperatura del mare si alza, gonfia\nil galleggiante che ha in testa e fluttua in gruppo.",
		'de-de': "Steigt die Meerestemperatur, bläst es seinen\nSchwimmbeutel auf und treibt in Schwärmen\nauf dem Wasser.",
