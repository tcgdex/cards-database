...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			...
			'es-es': "Este ataque hace 20 puntos de daño a 1 de los Pokémon en Banca de tu rival.",
			'it-it': "Questo attacco infligge 20 danni a uno dei Pokémon nella panchina del tuo avversario.",
			'de-de': "Diese Attacke fügt 1 Pokémon auf der Bank deines Gegners 20 Schadenspunkte zu.",
			'pt-br': "Este ataque causa 20 pontos de dano a 1 dos Pokémon no Banco do seu oponente.",
			'ko-kr': "상대의 벤치 포켓몬 1마리에게 20데미지를 준다."
		}
	}],
