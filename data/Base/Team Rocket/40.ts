	...
	attacks: [
		{
			...
			effect: {
				...
				de: "Wähle vor der Schadensverteilung ein Pokémon auf der Bank deines Gegners und tausche es mit dem verteidigenden Pokémon aus. Füge die Schadenspunkte dem neuen verteidigenden Pokémon zu. Dieser Angriff kann nicht gespielt werden, falls dein Gegner keine Pokémon auf der Bank hat."
			},
			damage: 20,
