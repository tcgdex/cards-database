	...
	abilities: [
		{
			...
			effect: {
				...
				de: "Einmal während deines Zuges (vor deinem Angriff) darfst du eine {{e|Feuer|px=15}}-Energiekarte von einem deiner anderen Pokémon wegnehmen und sie unter Glumanda legen. Diese Fähigkeit kann nicht gespielt werden, falls Glumanda schläft, verwirrt oder gelähmt ist."
			},
		},
	],
