...
const card: Card = {
	...
	effect: {
		...
		de: "Falls du diese Karte von deiner Hand spielst, entferne eine Schadensmarke von dem Pokémon, unter das du sie legst, falls es welche hat. Trank-Energie spendet {C}-Energie. (Zählt nicht als Basis-Energiekarte.)",
