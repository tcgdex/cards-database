	...
	attacks: [
		{
			...
			effect: {
				...
				de: "Fügt 20 Schadenspunkte mal die Gesamtanzahl der Smogons, Smogmogs und Dunklen Smogmogs im Spiel zu. (Schwäche und Resistenz anwenden.) Danach fügt dieser Angriff jedem Smogon, Smogmog und Dunklen Smogmog (selbst deinen eigenen) 20 Schadenspunkte zu. Schwäche und Resistenz nicht anwenden."
			},
			damage: "20x",
