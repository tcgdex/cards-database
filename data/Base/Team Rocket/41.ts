	...
	abilities: [
		{
			...
			effect: {
				...
				de: "Solange Dunkles Sleimok dein aktives Pokémon ist, zahlt dein Gegner {{e|Farblos|px=15}}{{e|Farblos|px=15}} mehr Rückzugskosten für sein oder ihr aktives Pokémon. Diese Fähigkeit verliert seine Wirkung, solange Dunkles Sleimok schläft, verwirrt oder gelähmt ist."
			},
		},
	],
