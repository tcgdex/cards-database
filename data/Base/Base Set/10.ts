	...
	attacks: [
		...
		},
		{
			...
			effect: {
				...
				de: "Entferne eine auf Mewtu abgelegte Psycho Energiekarte, um diesen Angriff auszuführen. Verhindere während des nächsten gegnerischen Zugs alle Auswirkungen von Angriffen auf Mewtu (einschließlich der Schadenspunkte).",
