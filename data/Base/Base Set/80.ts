...
const card: Card = {
	...
	effect: {
		...
		de: "Lege Defender auf einem Deiner Pokémon ab, und entferne die Karte nach dem nächsten gegnerischen Angriff wieder. Der Deinem Pokémon zugefügte Schaden wird um 20 Schadenspunkte reduziert (nachdem Schwäche und Resistenz abgerechnet wurden).",
