...
const card: Card = {
	...
	effect: {
		...
		de: "Wähle eine Basis-Pokémon-Karte vom Ablagestapel Deines Gegners und plaziere sie auf seiner Bank. (Du kannst Pokémon-Flöte nicht spielen, falls die Bank Deines Gegners voll ist.)",
