...
const card: Card = {
	...
	effect: {
		...
		de: "Lege eine Basis-Pokémon-Karte Deines Ablagestapels auf Deine Bank. Lege Schadensmarken in Höhe der Hälfte der KP des Pokémon (auf die nächste Zehnerstelle abgerundet) auf die Pokémon-Karte. (Du kannst Beleber nicht einsetzen, wenn Deine Bank voll ist.)",
