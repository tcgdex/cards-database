...
const card: Card = {
	...
	abilities: [
		{
			...
			effect: {
				...
				de: "Bist Du am Zug kannst Du (vor Deinem Angriff) beliebig oft eine auf einem Deiner Pokémon abgelegte Pflanze Energiekarte nehmen und auf ein anderes legen. Diese Fähigkeit kann nicht eingesetzt werden, falls Bisaflor schlafend, verwirrt oder gelähmt ist.",
	...
	description: {
		...
		de: "Die Pflanze auf dem Rücken folgt dem Lauf der Sonne."
	},
