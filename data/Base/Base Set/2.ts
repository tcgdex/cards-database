	...
	abilities: [
		{
			...
			effect: {
				...
				de: "Bist Du am Zug, kannst Du (vor Deinem Angriff) beliebig oft eine Wasser Energiekarte auf eines Deiner Pokémon ablegen. (Damit ist die Ablegemöglichkeit von einer Wasser Energiekarte pro Zug nicht aufgebraucht.) Diese Fähigkeit kann nicht eingesetzt werden, falls Turtok schlafend, verwirrt oder gelähmt ist.",
	...
	attacks: [
		{
			...
			effect: {
				...
				de: "Fügt 40 Schadenspunkte plus 10 weitere Schadenspunkte für jede auf Turtok abgelegte Wasser Energie zu, die nicht zum Zahlen der Energiekosten für diesen Angriff verwendet wurde. Du kannst nicht mehr als 20 Schadenspunkte auf diese Weise hinzufügen.",
