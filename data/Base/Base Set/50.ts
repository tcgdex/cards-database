	...
	attacks: [
		...
		},
		{
			...
			effect: {
				...
				de: "Entferne eine auf Nebulak abgelegte Psycho Energiekarte, um diesen Angriff auszuführen. Falls ein Pokémon Nebulak während des nächsten gegnerischen Zugs kampfunfähig macht, mache dieses Pokémon kampfunfähig.",
