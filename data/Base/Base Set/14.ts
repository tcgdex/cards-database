...
const card: Card = {
	...
	attacks: [
		{
			...
			effect: {
				...
				de: "Wirf eine Münze. Bei „Kopf“ verhindere während des nächsten gegnerischen Zugs alle Auswirkungen von Attacken auf Raichu (einschließlich der Schadenspunkte).",
		...
		},
		{
			...
			effect: {
				...
				de: "Wirf eine Münze. Bei „Zahl“ fügt Raichu sich selbst 30 Schadenspunkte zu.",
	...
	description: {
		...
		de: "Sein langer Schwanz dient als Erdung, um es vor seiner eigenen Hochspannung zu schützen."
	},
