	...
	attacks: [
		{
			...
			effect: {
				...
				de: "Du kannst beliebig viele Feuer-Energiekarten von Lavados entfernen, wenn du diesen Angriff einsetzt. Lege danach die gleiche Anzahl der obersten Karten vom Deck deines Gegners auf den Ablagestapel."
			},
