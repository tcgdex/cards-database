...
const card: Card = {
	...
	effect: {
		...
		fr: "Attachez cette carte à l'un de vos Pokémon {P} en jeu. Ce Pokémon peut utiliser l'attaque de cette carte à la place de la sienne. À la fin de votre tour, défaussez-vous de Cube psy 01.",
