...
const card: Card = {
	...
	effect: {
		...
		de: "Lege diese Karte an 1 deiner {D}-Pokémon im Spiel an. Dieses Pokémon kann den Angriff dieser Karte anstatt seiner eigenen verwenden. Lege am Ende deines Zuges Finsternis-Würfel 01 auf deinen Ablagestapel."
	},
