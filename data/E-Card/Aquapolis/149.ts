	...
	abilities: [
		{
			...
			effect: {
				...
				fr: "À chaque fois que vous attachez une carte Énergie de base {R}, {W}, ou {P} de votre main à Lugia, le type de Lugia (sa couleur) devient identique au type de carte Énergie jusqu'à la fin du tour.",
