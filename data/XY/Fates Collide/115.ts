...
const card: Card = {
	...
	effect: {
		fr: "Cette carte ne peut être attachée qu'à un Pokémon Combat. Cette carte ne fournit de l'Énergie Combat que pendant qu'elle est attachée à un Pokémon Combat.",
