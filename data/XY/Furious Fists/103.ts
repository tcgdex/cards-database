...
const card: Card = {
	...
	effect: {
		fr: "Cette carte ne peut être attachée qu'à un Pokémon Plante. Cette carte ne fournit de l'Énergie Plante que pendant qu'elle est attachée à un Pokémon Plante.",
