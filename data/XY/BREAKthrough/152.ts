...
const card: Card = {
	...
	effect: {
		...
		de: "Diese Karte liefert {C}-Energie. Ist sie im Spiel, zählt sie als jeder beliebige Energietyp, spendet aber immer nur jeweils 1 Energie. Wenn du diese Karte von deiner Hand an 1 deiner Pokémon anlegst, lege 1 Schadensmarke auf das Pokémon."
	},
