	...
	abilities: [
		{
			...
			effect: {
				...
				de: "Wenn an dieses Pokémon bereits mindestens 1 {L}-Energie angelegt ist, wird Schaden, der diesem Pokémon durch einen gegnerischen Angriff zugefügt wird, um 20 Schadenspunkte reduziert (nachdem Schwäche und Resistenz verrechnet wurden)."
			},
		},
	],
	...
	attacks: [
		{
			...
			effect: {
				...
				de: "Dieser Angriff fügt 20 weitere Schadenspunkte für jede an dieses Pokémon angelegte {L}-Energie zu."
			},
			damage: "50+",
