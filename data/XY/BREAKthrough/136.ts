...
const card: Card = {
	...
	effect: {
		...
		de: "Nimm 4 Basis-Energiekarten von deinem Ablagestapel auf deine Hand. Du kannst während deines Zuges (vor deinem Angriff) nur 1 Unterstützerkarte spielen."
	},
