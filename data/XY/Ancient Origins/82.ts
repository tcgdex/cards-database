...
const card: Card = {
	...
	effect: {
		fr: "Cette carte ne peut être attachée qu'à un Pokémon Obscurité. Cette carte ne fournit de l'Énergie Obscurité que pendant qu'elle est attachée à un Pokémon Obscurité.",
