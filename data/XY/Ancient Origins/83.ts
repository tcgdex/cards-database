...
const card: Card = {
	...
	effect: {
		fr: "Cette carte ne peut être attachée qu'à un Pokémon Électrique. Cette carte ne fournit de l'Énergie Électrique que pendant qu'elle est attachée à un Pokémon Électrique.",
