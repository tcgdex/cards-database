...
const card: Card = {
	...
	effect: {
		fr: "Choisissez l'orientation de cette carte avant de la jouer. Tous les dégâts infligés aux Pokémon Métal de ce ↓ joueur par une attaque de votre adversaire sont réduits de 10 (après application de la Faiblesse et de la Résistance).",
