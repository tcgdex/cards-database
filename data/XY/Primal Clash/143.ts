...
const card: Card = {
	...
	effect: {
		fr: "Cette carte ne peut être attachée qu'à un Pokémon Métal. Cette carte ne fournit de l'Énergie Métal que pendant qu'elle est attachée à un Pokémon Métal.",
