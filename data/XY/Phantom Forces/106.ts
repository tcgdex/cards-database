...
const card: Card = {
	...
	effect: {
		...
		de: "Nimm 1 Basis-Pokémon vom Ablagestapel deines Gegners und lege es auf seine Bank. Du kannst während deines Zuges (vor deinem Angriff) beliebig viele Itemkarten spielen."
	},
