...
const card: Card = {
	name: {
		...
		es: "Red Interferencia Hiperequipo del Team Flare",
		it: "Rete Disturbo [Dotazione Extra del Team Flare]",
	...
	effect: {
		...
		en: "The attacks of the Pokémon this card is attached to do 20 less damage to all Defending Pokémon (before applying Weakness and Resistance). (Don't apply Weakness and Resistance for Benched Pokémon.)\n\nWhen this card is removed from a Pokémon for any reason, put this card in its owner's discard pile.",
		es: "Los ataques del Pokémon al que esté unida esta carta hacen 20 puntos de daño menos a todos los Pokémon Defensores (antes de aplicar Debilidad y Resistencia). (No apliques Debilidad y Resistencia a los Pokémon en Banca).\n\nCuando se quite esta carta de un Pokémon por cualquier razón, pon esta carta en la pila de descartes de su dueño.",
		it: "Gli attacchi del Pokémon cui è assegnata questa carta infliggono 20 danni in meno a tutti i Pokémon difensori, prima di aver applicato debolezza e resistenza. Ricorda che non puoi applicare debolezza e resistenza ai Pokémon in panchina.\n\nSe per qualsiasi motivo questa carta viene rimossa da un Pokémon, metti questa carta nella pila degli scarti del suo proprietario.",
