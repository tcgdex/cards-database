...
const card: Card = {
	...
	effect: {
		...
		de: "Mische 1 deiner Pokémon und alle an es angelegten Karten zurück in dein Deck. Du kannst während deines Zuges (vor deinem Angriff) nur 1 Unterstützerkarte spielen."
	},
