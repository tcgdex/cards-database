...
const card: Card = {
	...
	abilities: [{
		...
		effect: {
			...
			de: "Jedes deiner Pokémon, an das mindestens 1 {G}-Energie angelegt ist, erholt sich von allen Speziellen Zuständen und kann nicht von Speziellen Zuständen betroffen werden."
		}
	}],
