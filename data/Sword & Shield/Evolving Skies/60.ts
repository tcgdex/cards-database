...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			...
			de: "Lege alle {L}-Energien von diesem Pokémon auf deinen Ablagestapel. Diese Attacke fügt auch 2 Pokémon auf der Bank deines Gegners 40 Schadenspunkte zu. (Wende Schwäche und Resistenz bei Pokémon auf der Bank nicht an.)"
		},
	...
	description: {
		...
		de: "Sein Körper besteht aus einem Organ, das elektrische Energie erzeugt. Regieleki kann genug Strom produzieren, um ganz Galar zu versorgen."
	},
