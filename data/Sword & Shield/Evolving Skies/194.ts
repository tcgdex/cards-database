...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			...
			de: "Du kannst bis zu 2 Basis-{R}-Energien oder Basis-{L}-Energien von diesem Pokémon auf deinen Ablagestapel legen. Diese Attacke fügt für jede auf diese Weise abgelegte Karte 80 Schadenspunkte mehr zu."
		},
