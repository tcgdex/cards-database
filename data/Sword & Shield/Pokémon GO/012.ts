...
const card: Card = {
	...
	abilities: [{
		...
		effect: {
			...
			de: "Die Attacken deiner Basis-{R}-Pokémon, außer Lavados, fügen dem Aktiven Pokémon deines Gegners 10 Schadenspunkte mehr zu (bevor Schwäche und Resistenz verrechnet werden)."
		}
	}],
