...
const card: Card = {
	...
	description: {
		...
		de: "Seine Schleimschicht hydriert seine Haut so effizient, dass es mehrere Tage an Land leben kann, ohne auszutrocknen."
	},
	...
	abilities: [{
		...
		effect: {
			...
			de: "Einmal während deines Zuges, wenn du dieses Pokémon auf deiner Hand hast, kannst du es deinem Gegner zeigen und unter dein Deck legen. Wenn du das machst, ziehe 1 Karte. Du kannst die Fähigkeit Gufa-Wurf nur einmal pro Zug einsetzen.",
