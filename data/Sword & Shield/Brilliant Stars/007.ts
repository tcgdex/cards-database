...
const card: Card = {
	...
	abilities: [{
		...
		effect: {
			...
			de: "Einmal während deines Zuges kannst du dein Deck nach 1 {G}-Pokémon durchsuchen, es deinem Gegner zeigen und auf deine Hand nehmen. Mische anschließend dein Deck."
		}
	}],
