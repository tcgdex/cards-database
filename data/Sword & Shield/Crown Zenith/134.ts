...
const card: Card = {
	...
	effect: {
		...
		de: "Während dieses Zuges fügen die Attacken deiner Pokémon dem Aktiven Pokémon deines Gegners 30 Schadenspunkte mehr zu (bevor Schwäche und Resistenz verrechnet werden). Du kannst während deines Zuges nur 1 Unterstützerkarte spielen."
	},
