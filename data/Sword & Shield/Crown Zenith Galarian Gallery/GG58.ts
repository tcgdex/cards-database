...
const card: Card = {
	...
	effect: {
		...
		de: "Nimm 1 deiner {C}-Pokémon, auf dem mindestens 1 Schadensmarke liegt, und alle angelegten Karten auf deine Hand. Du kannst während deines Zuges nur 1 Unterstützerkarte spielen."
	},
