...
const card: Card = {
	...
	effect: {
		...
		de: "Durchsuche dein Deck nach bis zu 3 Entwicklungs-Pokémon, die kein Regelfeld haben, zeige sie deinem Gegner und nimm sie auf deine Hand. Mische anschließend dein Deck. (Pokémon-V, Pokémon-GX usw. haben Regelfelder.) Du kannst während deines Zuges nur 1 Unterstützerkarte spielen."
	},
