...
const card: Card = {
	...
	abilities: [{
		...
		effect: {
			...
			de: "Einmal während deines Zuges, wenn dieses Pokémon in der Aktiven Position ist, kannst du für jedes Piepi auf deiner Bank dein Deck nach 1 {P}-Energiekarte durchsuchen und sie an jenes Piepi anlegen. Mische anschließend dein Deck."
		}
	}],
	...
	attacks: [{
		...
		effect: {
			...
			de: "Diese Attacke fügt für jede an alle deine Pokémon angelegte {P}-Energie 20 Schadenspunkte zu."
		},
