...
const card: Card = {
	...
	effect: {
		...
		de: "Zeige deinem Gegner die obersten 5 Karten deines Decks und veranlasse ihn dazu, 2 von ihnen zu wählen. Lege die gewählten Karten auf deinen Ablagestapel und nimm die verbleibenden Karten auf deine Hand. Du kannst während deines Zuges nur 1 Unterstützerkarte spielen."
	},
