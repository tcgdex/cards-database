...
const card: Card = {
	...
	attacks: [{
		...
		name: {
			'ja-jp': "ぶきみなしょくしゅ",
			'zh-tw': "不祥觸手",
			'th-th': "หนวดแห่งลางร้าย",
			'id-id': "Tentakel Menyeramkan"
		},
		...
		effect: {
			'ja-jp': "コインを3回投げ、オモテの数×80ダメージ。",
			'zh-tw': "擲3次硬幣，造成正面出現的次數×80點傷害。",
			'th-th': "ทอยเหรียญ 3 ครั้ง แดเมจจะเท่ากับจำนวนครั้งที่ออกหัว x80",
			'id-id': "Lempar koin 3 kali. Serangan ini memberikan kerusakan sejumlah 80 untuk tiap lemparan dengan hasil sisi depan."
		}
	}],
