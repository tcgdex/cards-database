...
const card: Card = {
	...
	description: {
		...
		'th-th': "เมื่อวิ่งจะมีไฟฟ้าผลิตออกมาจากโคนหาง เป็นที่นิยมในกาลาร์ในฐานะสุนัขเลี้ยงแกะ",
		'id-id': "Saat berlari, Yamper menghasilkan listrik pada bagian dasar ekornya. Populer sebagai anjing gembala di Galar."
	},
