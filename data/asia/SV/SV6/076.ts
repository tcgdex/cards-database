...
const card: Card = {
	...
	description: {
		...
		'th-th': "อาศัยอยู่ในถ้ำภูเขาไฟ จะใช้เล็บกากบาทเกาะกำแพงหรือเพดานแล้วไต่ไปเรื่อย",
	},
	...
	attacks: [
		{
			...
			effect: {
				'ja-jp': "このポケモンについている[M]エネルギーをすべてトラッシュし、その枚数×50ダメージ。",
				'zh-tw': "將這隻寶可夢身上附加的【鋼】能量卡全部丟棄，造成其張數×50點傷害。",
				'th-th': "ทิ้งพลังงาน[โลหะ]ที่ติดอยู่กับโปเกมอนนี้ทั้งหมดที่ตำแหน่งทิ้งการ์ด แดเมจจะเท่ากับจำนวนการ์ดนั้น x50",
			},
		},
	],
