...
const card: Card = {
	...
	description: {
		'th-th': "ค้นพบที่บริเวณใกล้กับปากปล่องภูเขาไฟ พ่นไฟออกมาจากปากได้ และ ร่างกายมันมีอุณหภูมิสูงถึง 1200 องศาเซลเซียส",
		'id-id': "Ia ditemukan di dekat kawah gunung berapi. Ia memuntahkan api dari mulut dan suhu tubuhnya pun bisa mencapai 1200 ℃."
	},
