...
const card: Card = {
	...
	description: {
		'ja-jp': "近年は 電脳空間で 大活躍。 怪しい データが ないか チェックして まわっている。",
		'zh-tw': "近年在電腦空間大展身手。會四處巡邏查看 有沒有可疑的資料。",
		'th-th': "หลายปีที่ผ่านมา มันมีบทบาทอย่างมากในไซเบอร์สเปซ คอยตระเวนตรวจสอบว่ามีข้อมูลน่าสงสัยหรือไม่",
	...
	attacks: [
		{
			...
			cost: ["Colorless"],
			effect: {
				'ja-jp': "[G][R][W][L][P][F][D][M][N]の中からタイプを1つ選ぶ。このワザを受けたポケモンの弱点は、選んだタイプになる。この効果は、このワザを受けたポケモンがバトル場をはなれるまで続く。［弱点は「×2」でダメージ計算をする。］",
				'zh-tw': "從【草】【火】【水】【雷】【超】【鬥】【惡】【鋼】【龍】中選擇1個屬性。受到這個招式的寶可夢弱點改為所選的屬性。這個效果在受到這個招式的寶可夢離開戰鬥場前一直持續。［弱點以「×2」計算傷害。］",
				'th-th': "เลือก 1 ประเภทจาก[หญ้า] [ไฟ] [น้ำ] [สายฟ้า] [พลังจิต] [ต่อสู้] [ความมืด] [โลหะ] [มังกร] จุดอ่อนของโปเกมอนที่ได้รับท่าต่อสู้นี้ จะเป็นประเภทที่เลือก เอฟเฟกต์นี้ จะต่อเนื่องไปจนกว่าโปเกมอนที่ได้รับท่าต่อสู้นี้จะออกจากตำแหน่งต่อสู้ {จุดอ่อน คำนวณแดเมจ x2}",
