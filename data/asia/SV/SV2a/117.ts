	...
	attacks: [
		{
			...
			effect: {
				...
				'th-th': "เทิร์นถัดไปของฝ่ายตรงข้าม เมื่อโปเกมอนที่ได้รับท่าต่อสู้นี้จะใช้ท่าต่อสู้ ฝ่ายตรงข้ามทอยเหรียญ 2 ครั้ง ถ้าออกก้อยแม้แต่ 1 ครั้ง ท่าต่อสู้นั้นจะล้มเหลว",
				'id-id': "Pada giliran lawan berikutnya, saat Pokémon yang menerima serangan ini menggunakan serangan, lawan melempar koin 2 kali. Jika salah satu hasilnya sisi belakang, serangan tersebut gagal.",
			},
		},
	],
