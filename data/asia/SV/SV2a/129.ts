	...
	attacks: [
		{
			name: {
				'ja-jp': "はねにはねる",
				'zh-tw': "跳了又跳",
				'th-th': "ดิ้นกระแด่วกระแด่ว",
				'id-id': "Lompatan Demi Lompatan",
			},
			cost: ["Water"],
			effect: {
				'ja-jp': "ウラが出るまでコインを投げ、オモテの数ぶん、自分の山札を引く。",
				'zh-tw': "擲硬幣直到出現反面，從自己的牌庫抽出與正面出現的次數相同數量的卡。",
				'th-th': "ทอยเหรียญจนกว่าจะออกก้อย จั่วการ์ดจากสำรับการ์ดฝ่ายเรา ตามจำนวนครั้งที่ออกหัว",
				'id-id': "Lempar koin hingga hasilnya sisi belakang. Ambil kartu dari atas Deck sendiri untuk tiap lemparan dengan hasil sisi depan.",
			},
		},
	],
