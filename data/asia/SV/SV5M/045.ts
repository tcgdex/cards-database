...
const card: Card = {
	...
	description: {
		'ja-jp': "おとなしい 顔で 相手を 油断 させてから おおあごで がぶり。 噛みつくと 絶対に 放さない。",
		'zh-tw': "用溫順的長相讓對手大意，然後用大顎一口咬住對手。 咬住後就絕不會鬆口。",
		'th-th': "ทำให้คู่ต่อสู้ตายใจด้วยใบหน้าดูสงบเสงี่ยม แล้วจึงขย้ำด้วยกรามใหญ่ เมื่อกัดแล้วจะไม่ปล่อยเด็ดขาด",
	},
