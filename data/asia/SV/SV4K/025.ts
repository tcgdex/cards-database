...
const card: Card = {
	...
	description: {
		...
		'ko-kr': "겉보기와 다르게 성질이 사납다. 기다란 몸으로 먹잇감을 죄어서 굴 안으로 끌고 들어간다."
	},
	...
	abilities: [{
		...
		effect: {
			...
			'ko-kr': "자신의 차례에 이 카드를 패에서 꺼내서 진화시켰을 때 1번 사용할 수 있다. 자신의 덱에서 「포켓몬의 도구」를 3장까지 선택해서 상대에게 보여주고 패로 가져온다. 그리고 덱을 섞는다."
		}
	}],
	...
	attacks: [{
		...
		effect: {
			...
			'ko-kr': "동전을 3번 던져서 앞면이 나온 수 × 70데미지를 준다."
		}
	}],
