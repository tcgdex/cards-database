...
const card: Card = {
	...
	description: {
		...
		'th-th': "พอร่างกายได้อาบคลื่นจากดวงจันทร์ ลายวงทั่วตัวจะเรืองแสงเล็กน้อยและพลังลึกลับจะตื่นขึ้น"
	},
	...
	attacks: [{
		...
		effect: {
			...
			'th-th': "ทำแดเมจ 50 กับโปเกมอนฝ่ายตรงข้าม 1 ตัว แดเมจของท่าต่อสู้นี้ จะไม่นำจุดอ่อน ความต้านทาน และเอฟเฟกต์ที่มีผลอยู่กับโปเกมอนที่ได้รับแดเมจมาคิด"
		}
	}, {
