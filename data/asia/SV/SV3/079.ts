...
const card: Card = {
	...
	description: {
		'ja-jp': "３つの 小さな ユニットを 使い エサを とったり 敵と 戦う。 本体は ほぼ 命令するだけ。",
		'zh-tw': "會驅使３個小組件去獲取食物或與敵人戰鬥。本體基本上只負責下命令。",
		'th-th': "จะใช้ร่างส่วนย่อยทั้ง 3 จับเหยื่อบ้างต่อสู้กับศัตรูบ้าง ส่วนร่างหลักส่วนใหญ่จะออกคำสั่งเพียงอย่างเดียว"
	},
