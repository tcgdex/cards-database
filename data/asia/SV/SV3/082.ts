...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			'ja-jp': "相手のバトルポケモンにダメカンが4個以上のっているなら、そのポケモンをきぜつさせる。",
			'zh-tw': "若對手的戰鬥寶可夢身上放置有4個以上的傷害指示物，則將那隻寶可夢【昏厥】。",
			'th-th': "ถ้าโปเกมอนบนตำแหน่งต่อสู้ฝ่ายตรงข้ามมีตัวนับแดเมจวางอยู่มากกว่าหรือเท่ากับ 4 ตัว จะทำให้โปเกมอนนั้น[หมดสภาพ]"
		}
	}, {
