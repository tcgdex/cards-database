...
const card: Card = {
	...
	description: {
		...
		'th-th': "สร้างไฟฟ้าจากหาง จะซ่อนตัวในเมฆฝนฟ้าคะนอง แล้วบินไปบนท้องฟ้าของภูมิภาคอิชชู"
	},
	...
	attacks: [{
		...
		effect: {
			...
			'th-th': "โปเกมอนบนเบนช์ฝ่ายเรา 1 ตัว ก็จะได้รับแดเมจ 40 ด้วย {โปเกมอนบนเบนช์จะไม่นำจุดอ่อนและความต้านทานมาคิด}"
		}
	}],
