...
const card: Card = {
	...
	description: {
		...
		'ja-jp': "脚が 短く 歩みは 遅いが 首と 触手が ３倍 伸びて 遠くにいる 獲物を 捕まえる。"
	},
	...
	attacks: [{
		...
		effect: {
			...
			'ja-jp': '相手のバトルポケモンが受けている特殊状態の数×100ダメージ。'
		},
	...
	abilities: [{
		...
		effect: {
			'ja-jp': "自分の番に1回使える。コインを1回投げオモテなら、どく・やけど・こんらんの中から1つ選び、相手のバトルポケモンをその状態にする。",
