...
const card: Card = {
	...
	description: {
		'id-id': "Galvantula mengincar anak burung yang belum dapat terbang dengan baik dan memasang jebakan menggunakan benang listrik di dekat sarang Pokémon burung."
	},
