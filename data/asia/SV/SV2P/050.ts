...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			'ja-jp': "自分の手札が、相手の手札と同じ枚数になるように、山札を引く。",
			'zh-tw': "從牌庫抽卡直到自己的手牌與對手的手牌張數相同為止。",
			'th-th': "จั่วการ์ดจากสำรับการ์ด จนได้การ์ดบนมือฝ่ายเรา เป็นจำนวนเท่ากับการ์ดบนมือฝ่ายตรงข้าม",
			'id-id': "Ambil kartu dari atas Deck hingga jumlah Kartu Pegangan sendiri menjadi sama dengan jumlah Kartu Pegangan lawan."
		}
	}, {
		cost: ["Metal", "Metal"],
