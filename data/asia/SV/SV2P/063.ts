...
const card: Card = {
	...
	description: {
		...
		'th-th': "มีนิสัยกล้าหาญบุ่มบ่าม ลายสีขาวรอบดวงตาจะข่มขวัญโปเกมอนที่ใจเสาะ",
		'id-id': "Rookidee bersifat pemberani dan nekat. Pola putih di sekitar matanya digunakan untuk menakut-nakuti Pokémon yang penakut."
	},
