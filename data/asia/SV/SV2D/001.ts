...
const card: Card = {
	...
	description: {
		'ja-jp': "風に 流され かなりの 距離を 移動する。 パルデアの ハネッコが どこから 来たのかは はっきりしない。",
		'zh-tw': "會隨著風移動到很遠的地方。沒有人能具體指出帕底亞的 毽子草是從哪裡來的。",
		'th-th': "โดนลมพัดจนลอยไปค่อนข้างไกล ยังไม่แน่ชัดว่าฮาเน็กโกะในพัลเดียนั้นมาจากไหน",
		'id-id': "Pokémon ini berpindah cukup jauh diterbangkan angin. Tidak diketahui kejelasan habitat asli dari Hoppip Paldea."
	},
