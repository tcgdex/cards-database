...
const card: Card = {
	...
	description: {
		'ja-jp': "季節風に 乗り 旅をする。 綿胞子が 尽きるとき 旅と ワタッコの 一生は 終わる。",
		'zh-tw': "會乘著季風到處旅行。當毽子棉的棉花孢子掉光時， 牠的旅行和生命也會隨之結束。",
		'th-th': "ออกเดินทางโดยล่องลอยไปตามลมมรสุม การเดินทางและชีวิตของวาทักโกะจะจบลงเมื่อเมล็ดฝ้ายหมดไป",
		'id-id': "Pokémon ini melakukan perjalanan dengan menaiki angin musim. Perjalanan dan kehidupan Jumpluff berakhir saat spora kapasnya habis diterbangkan."
	},
	...
	attacks: [{
		...
		name: {
			'ja-jp': "わたげのかぜ",
			'zh-tw': "棉絮之風",
			'th-th': "สายลมแห่งปุยฝ้าย",
			'id-id': "Angin Bulu Kapas"
		},
