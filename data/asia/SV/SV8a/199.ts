...
const card: Card = {
	...
	effect: {
		...
		'id-id': "Lihat 5 kartu dari atas Deck sendiri, pilih sesukanya kartu di antaranya, lalu buang ke Trash. Tukar urutan sisa kartu sesukanya, lalu kembalikan ke atas Deck.",
