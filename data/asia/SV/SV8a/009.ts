...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			'ja-jp': "自分のベンチポケモンの数×20ダメージ。",
			'id-id': "Serangan ini memberikan kerusakan sejumlah 20 untuk tiap Pokémon Cadangan sendiri.",
			'th-th': "แดเมจจะเท่ากับจำนวนโปเกมอนบนเบนช์ฝ่ายเรา x20",
