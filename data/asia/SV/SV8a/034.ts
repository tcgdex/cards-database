...
const card: Card = {
	...
	description: {
		...
		'th-th': "โดยปกติแล้วจะขยับตัวช้า ๆ แต่ตอนที่จะเข้ากัดขย้ำเหยื่อนั้นจะรวดเร็วจนมองไม่ทัน",
	...
	abilities: [{
		...
		effect: {
			...
			'th-th': "ใช้ได้ 1 ครั้งในเทิร์นฝ่ายเรา วางตัวนับแดเมจ 5 ตัวบนโปเกมอนนี้ เมื่อทำเช่นนั้นแล้ว เทิร์นนี้ แดเมจของท่าต่อสู้ที่โปเกมอนนี้ ใช้ทำกับโปเกมอนบนตำแหน่งต่อสู้ฝ่ายตรงข้ามจะถูก [+120]",
	...
	attacks: [{
		...
		effect: {
			...
			'th-th': "เทิร์นถัดไปของฝ่ายเรา โปเกมอนนี้จะใช้ [คลื่นลูกใหญ่] ไม่ได้",
