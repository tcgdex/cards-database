...
const card: Card = {
	...
	effect: {
		...
		'id-id': "Pilih 1 lembar Pokémon dari Kartu Pegangan sendiri, beri tahu lawan nama Pokémon tersebut, lalu taruh dengan sisi depan menghadap ke bawah. Lawan menebak HP Pokémon tersebut. Balikkan Pokémon tersebut sehingga sisi depannya menjadi menghadap ke atas, jika benar, lawan mengambil 4 kartu dari atas Deck. Jika salah, pemain mengambil 4 kartu dari atas Deck. Setelah itu, kembalikan kartu yang ditaruh tersebut ke Kartu Pegangan sendiri.",
