...
const card: Card = {
	...
	description: {
		...
		'th-th': "ดูเหมือนว่าจะเป็นร่างที่แท้จริงของราชาแห่งปีกที่ในบันทึกการสำรวจเก่ากล่าวว่ามันเคยแยกแผ่นดินด้วยกำปั้น",
	...
	attacks: [{
		...
		effect: {
			...
			'th-th': "แดเมจจะเท่ากับจำนวนโปเกมอน [โบราณ] บนกระดานฝ่ายเรา x30",
