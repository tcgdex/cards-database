...
const card: Card = {
	...
	abilities: [{
		...
		effect: {
			...
			'th-th': "โปเกมอนนี้ สามารถนำการ์ด [โปเกมอน【ex】] ที่จะวิวัฒนาการจาก [อีวุย] จาก บนมือออกมา วางบนโปเกมอนนี้เพื่อวิวัฒนาการได้ (ไม่สามารถวิวัฒนาการ ได้ในเทิร์นแรกสุดของฝ่ายเรา และเทิร์นที่เพิ่งออกมา)",
