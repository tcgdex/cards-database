...
const card: Card = {
	...
	description: {
		'id-id': "Sisik Kingdra yang rontok dijadikan sebagai persembahan kepada keluarga kerajaan karena kilauannya yang berkualitas tinggi dan berbobot."
	},
