...
const card: Card = {
	...
	description: {
		'id-id': "Sedang menjalani pertumbuhan di dalam cangkang. Dottler menggunakan kekuatan psikokinesis untuk mendeteksi kondisi di luar cangkang dan bersiap untuk evolusi."
	},
