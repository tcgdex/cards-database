...
const card: Card = {
	...
	description: {
		...
		'th-th': "มีสติปัญญาเป็นเลิศและห้าวหาญมาก เล็งและใช้ค้อนทุบหินให้กระเด็นไปโดนอาร์เมอร์การ์ที่บินอยู่",
	...
	abilities: [{
		...
		effect: {
			...
			'th-th': "ในเทิร์นฝ่ายเรา ถ้าทิ้งการ์ดบนมือฝ่ายเรา 1 ใบที่ตำแหน่งทิ้งการ์ด ใช้ได้ 1 ครั้ง จั่วการ์ด 3 ใบจากสำรับการ์ดฝ่ายเรา",
	...
	attacks: [{
		...
		effect: {
			...
			'th-th': "ถ้าโปเกมอนนี้มีพลังงานพิเศษติดอยู่ การโจมตีนี้จะเพิ่มแดเมจอีก 90",
