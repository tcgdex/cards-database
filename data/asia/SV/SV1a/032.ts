...
const card: Card = {
	...
	attacks: [{
		...
		name: {
			...
			'zh-tw': "揚風",
			'th-th': "ลมทำลายล้าง",
			'id-id': "Angin Pengacau"
		},

		effect: {
			'ja-jp': "相手は相手自身の手札をすべて山札にもどして切る。その後、相手は山札を4枚引く。",
			'zh-tw': "對手將對手自己的手牌全部放回牌庫並重洗。然後，對手從牌庫抽出4張卡。",
			'th-th': "ฝ่ายตรงข้ามนำการ์ดบนมือฝ่ายตรงข้ามเองทั้งหมดใส่กลับไปในสำรับการ์ดแล้วสับ หลังจากนั้น ฝ่ายตรงข้ามจั่วการ์ด 4 ใบจากสำรับการ์ด",
			'id-id': "Lawan mengocok kembali semua Kartu Pegangannya ke Deck. Setelah itu, lawan mengambil 4 kartu dari atas Deck."
		}
	}, {
