...
const card: Card = {
	...
	description: {
		...
		'id-id': "Kabarnya, sudah sejak dahulu kala manusia menunggangi punggung Cyclizar. Situasi tersebut terlukiskan dalam sebuah mural dari 10 ribu tahun lalu."
	},
	...
	attacks: [{
		...
		name: {
			'ja-jp': "こうそくドライブ",
			'zh-tw': "高速猛衝",
			'id-id': "Berkendara Berkecepatan Tinggi"
		},
