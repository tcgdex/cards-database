...
const card: Card = {
	...
	attacks: [{
		...
		name: {
			'zh-tw': "[VSTAR力量]星星密碼",
			'th-th': "[พลังVSTAR] สตาร์ไซเฟอร์",
			'ja-jp': "スターサイファー"
		},

		effect: {
			'zh-tw': "這隻寶可夢離場前，擁有「對手的所有場上寶可夢的弱點全部改爲【超】屬性。」效果的特性。[弱點以「×2」計算傷害。][對戰中，己方只可使用1次【VSTAR】力量。]",
			'th-th': "จนกว่าจะออกจากกระดาน โปเกมอนนี้จะมีความสามารถที่มีเอฟเฟกต์ว่า [จุดอ่อนของโปเกมอนบนกระดานฝ่ายตรงข้ามทุกตัว จะเป็นประเภท[พลังจิต]ทั้งหมด] [จุดอ่อน คำนวณแดเมจ x2] {ในระหว่างการแบตเทิล ฝ่ายเราใช้พลัง【VSTAR】ได้ 1 ครั้งเท่านั้น}",
