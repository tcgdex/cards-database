...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			...
			'th-th': "ทอยเหรียญ 1 ครั้ง ถ้าออกหัว เทิร์นถัดไปของฝ่ายตรงข้าม แม้โปเกมอนนี้[หมดสภาพ] ฝ่ายตรงข้ามไม่สามารถหยิบการ์ดรางวัลได้",
			'ja-jp': "コインを1回投げオモテなら、次の相手の番、このポケモンがきぜつしても、相手はサイドをとれない。"
		},
