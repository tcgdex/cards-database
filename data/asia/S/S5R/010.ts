...
const card: Card = {
	...
	description: {
		...
		'th-th': "ถูกเรียกว่าเป็นเทพพิทักษ์ แต่ก็มีความเกรี้ยวกราดที่คอยจัดการผู้ที่มองว่าเป็นศัตรูอย่างเด็ดขาด"
	},
	...
	attacks: [{
		...
		name: {
			'zh-tw': "大自然的裁決",
			'th-th': "ธรรมชาติลงทัณฑ์"
		},

		effect: {
			'zh-tw': "若希望，將這隻寶可夢身上附加的能量全部丟棄。這個情況下，增加80點傷害。",
			'th-th': "หากต้องการ ทิ้งพลังงานที่ติดกับโปเกมอนนี้ทั้งหมดที่ตำแหน่งทิ้งการ์ด เมื่อทำเช่นนั้น การโจมตีนี้จะเพิ่มแดเมจอีก 80"
		},
