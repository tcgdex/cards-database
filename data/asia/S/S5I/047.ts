	...
	attacks: [
		{
			...
			effect: {
				...
				'th-th': "เลือกการ์ดไอเท็ม 1 ใบจากตำแหน่งทิ้งการ์ดฝ่ายเรา ให้ฝ่ายตรงข้ามดูแล้วนำขึ้นมือ",
			},
		},
		{
			name: {
			...
			cost: ["Darkness"],
			effect: {
				'ja-jp': "自分の手札が1枚もないなら、90ダメージ追加。",
				'zh-tw': "若自己1張手牌都沒有，則增加90點傷害。",
				'th-th': "ถ้าบนมือฝ่ายเราไม่มีการ์ดเลยแม้แต่ 1 ใบ การโจมตีนี้จะเพิ่มแดเมจอีก 90",
			},
		},
	],
