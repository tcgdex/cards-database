	...
	attacks: [
		{
			...
			effect: {
				...
				'th-th': "เลือกการ์ดโปเกมอน [พื้นฐาน] ได้สูงสุด 2 ใบจากสำรับการ์ดฝ่ายเราแล้ววางบนเบนช์ แล้วสับสำรับการ์ด",
			},
		},
		{
			name: {
			...
			effect: {
				...
				'th-th': "ทอยเหรียญจนกว่าจะออกก้อย การโจมตีนี้จะเพิ่มแดเมจเท่ากับจำนวนครั้งที่ออกหัว x30",
			},
		},
	],
