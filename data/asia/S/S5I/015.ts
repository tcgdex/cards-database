...
const card: Card = {
	...
	description: {
		'ja-jp': "停電が 起こる 原因に されることが 多いが 実は 会社の ミスの ほうが多い。",
		'zh-tw': "人們經常把停電的原因歸咎到牠們身上，但其實大多是電力公司的過失。",
		'th-th': "มักถูกมองว่าเป็นต้นเหตุของการเกิดไฟดับอยู่บ่อย ๆ แต่ความจริงแล้วส่วนใหญ่เป็นเพราะความผิดพลาดของบริษัทไฟฟ้า",
	},
