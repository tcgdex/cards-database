...
const card: Card = {
	...
	description: {
		'ja-jp': "獲物の 背後に 忍び寄り 気づかれる 前に 毒ガスを 浴びせて 動けなくしてしまう。",
		'zh-tw': "悄悄地從背後靠近獵物，在對方察覺之前釋放毒氣，讓對方動彈不得。",
		'th-th': "ลอบเข้าใกล้เหยื่อจากด้านหลัง ก่อนที่เหยื่อจะรู้ตัว มันจะอาบตัวเหยื่อด้วยแก๊สพิษและทำให้เคลื่อนไหวไม่ได้",
	},
