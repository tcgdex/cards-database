...
const card: Card = {
	...
	description: {
		...
		'th-th': "จะคอยแทะไม้หรือหินอยู่เสมอเพื่อลับฟันหน้าที่แข็งแรง สร้างรังอาศัยอยู่ริมน้ำ",
	},
	...
	abilities: [
		{
			...
			effect: {
				...
				'th-th': "โปเกมอนนี้ ตราบใดที่ยังอยู่บนเบนช์ จะไม่ได้รับแดเมจจากท่าต่อสู้",
			},
		},
	],
