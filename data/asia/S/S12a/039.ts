	...
	abilities: [
		{
			...
			effect: {
				'ja-jp': "このポケモンがいるかぎり、おたがいのプレイヤーは、手札からエネルギーを「ポケモンV」につけるたび、そのポケモンにダメカンを2個のせる。",
				'zh-tw': "只要這隻寶可夢在場上，雙方玩家每次從手牌將能量附於「寶可夢【V】」身上時，在那隻寶可夢身上放置2個傷害指示物。",
				'th-th': "ตราบใดที่โปเกมอนนี้ยังอยู่ ทุกครั้งที่ผู้เล่นทั้งสองฝ่ายติดการ์ดพลังงานจากบนมือที่ [โปเกมอน【V】] ให้วางตัวนับแดเมจ 2 ตัวบนโปเกมอนนั้น",
			},
		},
	],
