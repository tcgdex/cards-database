	...
	abilities: [
		{
			...
			effect: {
				...
				de: "Du kannst mit Flutlicht 10 Schadenspunkte mehr für jede an Lanturn angelegte Wasser-Energie, die nicht zum Zahlen der Energiekosten für Flutlicht verwendet wird, zufügen. Diese Fähigkeit kann nicht verwendet werden, falls Lanturn schläft, verwirrt oder gelähmt ist."
			},
		},
	],
