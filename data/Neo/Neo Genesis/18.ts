	...
	abilities: [
		{
			...
			effect: {
				...
				de: "Wenn du Tornupto aus deiner Hand spielst, kannst du eine Münze werfen. Suche bei „Kopf“ in deinem Deck nach bis zu 4 Feuer-Energiekarten und lege sie an Tornupto an. Mische dein Deck danach."
			},
		},
	],
	...
	attacks: [
		{
			...
			effect: {
				...
				de: "Lege 3 an Tornupto angelelgte Feuer-Energiekarten auf deinen Ablagestapel, um diesen Angriff zu verwenden. Füge allen Pokémon auf der Bank 20 Schadenspunkte zu (deinen und den gegnerischen). (Wende Schwäche und Resistenz bei Pokémon auf der Bank nicht an.)"
			},
			damage: 80,
