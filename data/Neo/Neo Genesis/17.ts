	...
	abilities: [
		{
			...
			effect: {
				...
				de: "Einmal während deines Zuges (vor deinem Angriff) kannst du eine Münze werfen. Lege bei „Kopf“ eine Feuer-Energiekarte aus deinem Ablagestapel auf eines deiner Feuer-Pokémon. Diese Fähigkeit kann nicht verwendet werden, falls Tornupto schläft, verwirrt oder gelähmt ist."
			},
		},
	],
