	...
	attacks: [
		{
			...
			effect: {
				...
				fr: "Lancez une pièce. Si c'est face, choisissez une attaque d'un des Pokémon de votre adversaire. Super Métronome copie cette attaque à l'exception de son coût en Énergie. (Vous devez toujours accomplir les autres actions afin d'utiliser cette attaque.) (Quel que soit le type du Pokémon Défenseur, Togetic reste {C}.) Togetic accomplie cette attaque. (Togetic peut accomplir l'attaque même s'il ne possède pas le nombre d'Énergies requises pour faire cette attaque.)",
				de: "Wirf eine Münze. Wähle bei „Kopf“ einen der Angriffe eines der gegnerischen Pokémon. Supermetronom kopiert diesen Angriff außer den Energiekosten. (Du musst allerdings alles andere tun, um diesen Angriff zu verwenden.) (Unabhängig vom Typ des gegnerischen Pokémon ist Togetics Typ immer noch {C}.) Togetic führt diesen Angriff aus. (Togetic kann diesen Angriff ausführen, selbst wenn nicht die entsprechende Anzahl und Sorte Energiekarten daran angelegt sind, die nötig wären, um diesen Angriff auszuführen.)"
			},
		...
		},
		{
			...
			effect: {
				...
				de: "Wirf eine Münze. Verhindere bei „Kopf“ während des nächsten gegnerischen Zugs alle Auswirkungen von Angriffen auf Togetic (einschließlich der Schadenspunkte); bei „Zahl“ hat dieser Angriff keine Auswirkungen (nicht einmal Schadenspunkte)."
			},
			damage: 30,
