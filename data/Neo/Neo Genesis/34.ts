	...
	attacks: [
		{
			...
			effect: {
				...
				de: "Lege alle an Waaty angelegten Elektro-Energiekarten auf den Ablagestapel, um diesen Angriff zu verwenden. Wirf eine Anzahl Münzen gleich der Anzahl so abgelegter Elektro-Energiekarten. Dieser Angriff fügt 30 Schadens-punkte mal der Anzahl „Kopf“ zu."
			},
			damage: "30x",
		...
		},
		{
			...
			effect: {
				...
				de: "Nimm eine an Waaty angelegte Elektro-Energiekarte und lege sie auf eines deiner Pokémon auf der Bank. Falls du keine Pokémon auf der Bank hast, lege diese Energiekarte auf deinen Ablagestapel."
			},
			damage: 20,
