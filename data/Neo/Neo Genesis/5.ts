...
const card: Card = {
	...
	attacks: [
		{
			...
			effect: {
				...
				de: "Fügt 10 Schadenspunkte plus 10 Schadenspunkte mal der Anzahl an Wasser-Energiekarten in deinem Ablagestapel zu. Mische danach alle Wasser-Energiekarten aus deinem Ablagestapel in dein Deck."
			},
			damage: "10+",
	...
	abilities: [{
		...
		effect: {
			...
			de: "Bist du am Zug, kannst du (vor deinem Angriff) beliebig viele Wasser-Energiekarten aus deiner Hand abwerfen. Diese Fähigkeit kann nicht verwendet werden, wenn Impergator schläft, verwirrt oder gelähmt ist."
		},
