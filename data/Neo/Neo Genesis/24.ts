	...
	attacks: [
		{
			...
			effect: {
				...
				de: "Das verteidigende Pokémon kann sich nicht zurückziehen, solange Kramurx dein aktives Pokémon bleibt. (Kommt eins der beiden Pokémon auf die Bank oder entwickelt sich, endet diese Wirkung.)"
			},
