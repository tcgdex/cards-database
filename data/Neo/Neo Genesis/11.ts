	...
	abilities: [
		{
			...
			effect: {
				...
				de: "Solange Meganie im Spiel ist, liefert jede Pflanze-Energie, die an deine Pflanze-Pokémon angelegt ist, stattdessen PflanzePflanze. Diese Fähigkeit verliert ihre Wirkung, solange Meganie schläft, verwirrt oder gelähmt ist."
			},
		},
	],
