...
const card: Card = {
	...
	attacks: [{
		...
		effect: {
			...
			es: "Lanza 1 moneda. Si sale cara, el Pokémon Activo de tu rival pasa a estar Paralyze.",
			it: "Lancia una moneta. Se esce testa, il Pokémon attivo del tuo avversario viene Paralyze.",
			...
			'pt-br': "Jogue uma moeda. Se sair cara, o Pokémon Ativo do seu oponente agora estará Paralyze.",
			ko: "동전을 1번 던져서 앞면이 나오면 상대의 배틀 포켓몬을 Paralyze[Gr:Patchim v=\"으로/로\" ] 만든다."
		},
