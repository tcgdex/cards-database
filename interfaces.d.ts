...
interface variant_detailed {
	 ...
	 */
	stamp?: Array<'1st-edition' | 'w-promo' | 'pre-release' | 'pokemon-center' | 'play-pokemon' | 'set-logo' | 'staff' | 'pikachu-tail'
	...
	| 'mirror' | 'league' | 'player-reward' | 'professor-program' | 'mirage' | 'vertical-lines' | 'speckle'
